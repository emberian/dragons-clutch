...
test("source_and_structured_action_material_use_disjoint_current_transport_contracts", () => {
  ...
  const result = vm.runInContext(`(() => {
    ...
    const dealerLabels = ["actor","policy","state-v3","facility-position-v3","facility-replay-v3","funded-dependencies-v2","dealer-liveness-schedule-v1","liveness-policy","liveness-source","liveness-candidate","liveness-clearing","liveness-settlement","liveness-resolution","liveness-retirement","liveness-recovery","liveness-receipt","liveness-payer","position-rent-payer","replay-rent-payer","obligation-rent-payer","neutral-lamport-sink","clock-sysvar","rent-sysvar","system-program","dealer-series-obligation-v3","realm","collateral-profile-v2","collateral-policy-v2","collateral-token-program","collateral-token-programdata","market-binding-v2","market-runtime-v3","market-instance-v2","hoard-v2","claim-ledger-v3","dealer-future-credit-funding-v1","product-market-root-v3","series-market-link-v3"];
    const dealerWritable = new Set([0,2,3,4,13,15,16,17,18,19,20,24,35,36,37]);
