...
(function (root) {
  ...
  const renderKeeper = (snapshot) => {
    ...
    for (const action of actions) {
      const fractionalHolderPending = action.coordinate.familyTag === "79" && action.coordinate.familyVersion === "1" && action.coordinate.localAction === "4";
