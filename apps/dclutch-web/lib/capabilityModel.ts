...
export const CAPABILITY_ACTIONS_V1: ReadonlyArray<CapabilityActionV1> = Object.freeze([
  ...
  action('market.found', 'author', 'Creation', 'Found common Core Market', 'browser-unsigned', '/found', false, 'The Found37 workspace independently authenticates the Product record graph, infrastructure profile and current Registry/Rent artifacts before constructing unsigned v0 bytes.'),
