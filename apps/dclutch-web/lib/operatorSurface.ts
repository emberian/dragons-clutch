...
export const OPERATOR_WORKFLOWS: ReadonlyArray<OperatorWorkflowV1> = Object.freeze([
  ...
  { family: 'Creation', action: 'Found common Core Market', status: 'constructible', route: '/found', exactBoundary: 'Runtime V2 Product records, Found31 accounts, immutable infrastructure artifacts, Loader state, rent, and payer are reacquired before unsigned v0 construction.' },
