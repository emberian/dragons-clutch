...
export default function RationalRepresentationWorkspace() {
  ...
  return <main className="product-shell trade-v3-shell">
    ...
    <section className="trade-v3-hero"><div><p className="eyebrow">Bearer · Rational · Structured successor boundary</p><h1>Decimals are a label.<br /><em>Atoms are the economics.</em></h1><p>The executable path below is an ordinary Token-2022 transfer selected by immutable Market Realm and release state. The browser derives TokenBehaviorSelectionV2, rejects behavior-changing Mint and Account extensions, and never converts a display quantity into protocol units.</p></div><aside><span>Executable now</span><strong>Bearer transfer</strong><p>Denominate, reconstitute, Structured issue/unwrap, terminal redeem, and receipt retirement remain fail-closed here until their finalized CapabilityV4 outer routes are joined.</p></aside></section>
    ...
    <section className="trade-v3-card">
      ...
      <div className="trade-v3-evidence"><article><span>Bearer transfer</span><strong>transaction-complete</strong><small>exact TransferChecked · v0 + ALT</small></article><article><span>Denominate / reconstitute</span><strong>fail closed</strong><small>CapabilityV4 bundle migration active</small></article><article><span>Terminal redeem</span><strong>fail closed</strong><small>zero payout is valid; common Hot evidence pending</small></article><article><span>Receipt retirement</span><strong>fail closed</strong><small>closure only; not a payout route</small></article></div>
    </section>
