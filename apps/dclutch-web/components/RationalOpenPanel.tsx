...
export default function RationalOpenPanel() {
  ...
  return <>
    <section className="trade-v3-card">
      <header><span>04</span><div><h2>Open native shards or a Structured receipt from one Product graph</h2><p>Denominate, reconstitute, issue, and unwrap share one variable-width family. The browser independently derives representation width K, terminal-result width N, coefficients, Mints, custody, Positions, replay revisions, and physical aliases from finalized chain state; users choose only an action and raw-atom quantity.</p></div></header>
