...
export default function OperatorSurface() {
  ...
  return <main className="product-shell operator-shell">
    <header className="product-nav"><Anchor className="brand" href="/"><span className="brand-mark">dC</span><span>dClutch</span></Anchor><nav><Anchor href="/trade">Direct</Anchor><Anchor href="/resolution">Resolution</Anchor><Anchor href="/redeem">Redeem</Anchor><Anchor href="/general">General</Anchor><Anchor href="/release">Release</Anchor><Anchor className="active" href="/operate">Operate</Anchor><Anchor href={docsIndexHrefV1()}>Docs</Anchor></nav><span className="preview-control"><i className="preview-dot" />unsigned only</span></header>
