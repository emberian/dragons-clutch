...
export default function DirectWorkspace() {
  ...
  async function buildIntent(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (lifecycleTag > 2) throw new Error('compiled lifecycle must be FOK 0, IOC 1, or registered 2');
