...
from the captured account body.
...
It
does not replace those observations with captured headers and never claims the
captured provider release identity. The fixture publish time also differs from
