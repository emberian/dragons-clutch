...
use super::obligation::{DEALER_OBLIGATION_PDA_DOMAIN_V3, DealerObligationProjectionV3};
...
mod tests {
    use super::*;
    use crate::dealer::{
        multi_lp::DEALER_LP_POSITION_BYTES_V3,
        obligation::{
    ...
    /// `lp_accelerator::authenticate_position` — with no all-zero
