...
mod tests {
    ...
    fn every_child_role_the_equity_routes_to_has_an_invocable_program_coordinate() {
        ...
        for action in [MultiLpActionV3::Add, MultiLpActionV3::Remove] {
            for positions in 0..=2_u32 {
                ...
                let count = crate::dealer::equity_profile::dealer_equity_logical_account_count_v3(
                    action, positions,
                )
                ...
                *lengths
                    .get_mut(usize::from(
                        crate::dealer::equity_profile::LINKED_BASIS_CONTENT_ACCOUNT_V3,
                    ))
                    .expect("linked-basis content coordinate") = 1;
                let profile_bytes =
                    crate::dealer::equity_profile::encode_dealer_equity_account_profile_v3(
                        crate::dealer::equity_profile::DealerEquityAccountProfileInputV3 {
                            action,
    ...
    fn typed_p2_contribution_artifact_has_exact_routes_and_dependency() {
        ...
        assert_eq!(
            ...
            crate::dealer::equity_profile::dealer_equity_logical_account_count_v3(
                MultiLpActionV3::Add,
                2
            )
