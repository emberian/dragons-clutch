...
use super::{
    ...
    v3_trade_artifacts::{
        ...
        DEALER_SCENARIO_EVIDENCE_SPAN_COUNT_SCALAR_V4, DEALER_SCENARIO_EXPIRY_SCALAR_V4,
        DEALER_SCENARIO_MAX_EVIDENCE_SPAN_COUNT_SCALAR_V4, DEALER_SCENARIO_OBLIGATION_IDENTITY_V4,
        DEALER_SCENARIO_POSITION_COUNT_SCALAR_V4, DEALER_SCENARIO_POSITION_GEOMETRY_SUM_SCALAR_V4,
        DEALER_SCENARIO_WITNESS_BYTES_SCALAR_V4, project_dealer_scenario_hot_registers_v4,
    },
};
...
fn authenticate_input_bank(
    ...
    for (index, expected) in [
        ...
        (DEALER_SCENARIO_MAX_EVIDENCE_SPAN_COUNT_SCALAR_V4, 3),
        (DEALER_SCENARIO_POSITION_GEOMETRY_SUM_SCALAR_V4, 2),
        (
