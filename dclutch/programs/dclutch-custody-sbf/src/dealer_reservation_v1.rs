...
use crate::{
    CustodySbfError, PoststateProjection, TransferAccounts, account, authenticate_replay_identity,
    authenticate_reservation_frame_v1, authenticate_transfer_accounts, create_vault,
    initialize_vault, invoke_close, invoke_exact_transfer, poststate_commitment, read_replay,
    validate_custody_authority, validate_token_program_and_mint, validate_vault_key,
};
...
fn authenticate_effect(
    ...
    authenticate_reservation_frame_v1(program_id, &release_frame, custody, true)?;
    crate::custody_cu_checkpoint!("dr-frame");
...
fn execute_reserve_token_effect(
    ...
    let realm = authenticate_reservation_frame_v1(program_id, &realm_frame, original, false)?;
...
fn authenticate_activation_release(
    ...
    let realm = authenticate_reservation_frame_v1(program_id, &release_frame, request, true)?;
