...
impl AffineBatchTestCallerError {
    ...
    /// [`AffineBatchTestCallerError::ordinal`], whose match is exhaustive: a variant added to the
    ...
    /// This refusal's position in [`AffineBatchTestCallerError::ALL`].
    ///
...
const _: () = {
    assert!(
        AffineBatchTestCallerError::ALL[0] as u32
