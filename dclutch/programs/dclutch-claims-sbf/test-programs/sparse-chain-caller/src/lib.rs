...
impl SparseChainCallerError {
    ...
    /// [`SparseChainCallerError::ordinal`], whose match is exhaustive: a variant added to the enum
    ...
    /// This refusal's position in [`SparseChainCallerError::ALL`].
    ///
...
const _: () = {
    assert!(
        SparseChainCallerError::ALL[0] as u32
