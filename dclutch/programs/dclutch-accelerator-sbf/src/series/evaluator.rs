...
const SERIES_SHADOW_CLAIMS_ACCOUNT_COUNT_V4: usize = 32;
const SERIES_SHADOW_CORE_OPEN_ACCOUNT_COUNT_V4: usize = 37;
...
pub(crate) const SERIES_RENT_SYSVAR_COORDINATE_V4: usize =
    SERIES_SHADOW_FOUND_ACCOUNT_START_V4 + 28;
pub(crate) const SERIES_LINKED_BASIS_STAGING_COORDINATE_V4: usize =
    SERIES_SHADOW_FOUND_ACCOUNT_START_V4 + 13;
...
const _: () = assert!(SERIES_SHADOW_LOGICAL_ACCOUNT_BASE_V4 == 161);
const _: () = assert!(SERIES_RENT_SYSVAR_COORDINATE_V4 == 47);
const _: () = assert!(SERIES_LINKED_BASIS_STAGING_COORDINATE_V4 == 32);
const _: () = assert!(SERIES_TICKET_STATE_COORDINATE_V4 == 59);
const _: () = assert!(SERIES_TEMPLATE_RAW_COORDINATE_V4 == 60);
const _: () = assert!(SERIES_OCCURRENCE_RAW_COORDINATE_V4 == 62);
const _: () = assert!(SERIES_TICKET_RAW_COORDINATE_V4 == 64);
const _: () = assert!(SERIES_CLOCK_COORDINATE_V4 == 66);
...
pub(crate) fn funding_count(request: ShadowRequestV3<'_>) -> Result<usize> {
