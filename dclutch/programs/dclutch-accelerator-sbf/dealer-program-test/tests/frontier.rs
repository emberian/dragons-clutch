...
//!
//! the Dealer arm of `dclutch-accelerator-sbf` collapses every authentication refusal to
//! one opaque code (`DealerAcceleratorSbfErrorV4::InvalidInvocation`, 0xC101),
