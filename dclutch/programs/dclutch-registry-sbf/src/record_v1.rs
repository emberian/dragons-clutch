...
/// image of the FOLDED accelerator -- General, Dealer and series-shadow in one
/// program -- deployed to devnet by cohort-16 on 2026-09-05 at slot
/// 493,639,473, which is its first deployment on any chain; the pre-fold
/// `dclutch-general-accelerator-sbf` these facts used to name was closed by the
/// same cohort and its ProgramData no longer exists. Every
...
/// That is the cohort's own `prepare`/`administration` pair, and the runbook
...
mod devnet_general_accelerator_observation {
    ...
    /// `6v1c2Go2h1rxkTN2EmzC5xGC35MTbaHPCHrKF6kTvg4y`.
    const PROGRAM: [u8; 32] = [
        0x57, 0xde, 0xe6, 0x77, 0x8a, 0x0f, 0x98, 0xb7, 0x56, 0xa2, 0x53, 0x6c, 0x54, 0x8c, 0x92,
        0xa8, 0xca, 0xfd, 0xa2, 0x93, 0xc6, 0x8d, 0x40, 0xb7, 0x98, 0xb2, 0x75, 0x8c, 0xfc, 0x21,
        0xb7, 0x6a,
    ];
    /// `DfJLGB1W12cUYGpw3doG2DmMDe6ubR2UkmrrUsqosa9g`, the derived ProgramData.
    const PROGRAMDATA: [u8; 32] = [
        0xbc, 0x1b, 0xe9, 0x4c, 0x99, 0x31, 0x6d, 0xb2, 0xb1, 0x70, 0xf4, 0x97, 0x4d, 0x94, 0x22,
        0x96, 0xef, 0x86, 0x67, 0xb3, 0xa2, 0xd2, 0xa0, 0xdf, 0x39, 0x32, 0x61, 0xd4, 0xf7, 0xe2,
        0x8d, 0x4b,
    ];
    ...
    const ELF_DIGEST: [u8; 32] = [
        0x58, 0x71, 0x81, 0xd9, 0x53, 0x6d, 0x19, 0xf4, 0xed, 0x40, 0xdd, 0xeb, 0xb0, 0x1e, 0xba,
        0xc1, 0xd3, 0xe3, 0x54, 0x4d, 0x28, 0x11, 0x0c, 0x3d, 0x7e, 0x1c, 0xa0, 0x4b, 0x4e, 0x4c,
        0x87, 0xab,
    ];
    /// `0x1d6c5731`, from bytes 4..12 of the ProgramData header.
    const DEPLOYMENT_SLOT: u64 = 493_639_473;
