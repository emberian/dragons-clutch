...
mod devnet_general_accelerator_observation {
    ...
    /// `WMGVfhVuWuMRCkBDnR7nrqj6uY1XbnxQtShxdM4h7km`.
    const PROGRAM: [u8; 32] = [
        0x07, 0x84, 0xc2, 0x74, 0xc4, 0x0e, 0x4f, 0x05, 0x89, 0x1d, 0x0c, 0x6c, 0xe6, 0x66, 0x01,
        0xef, 0x66, 0x70, 0x8f, 0xc0, 0xee, 0x21, 0xc1, 0x5c, 0xf2, 0xe5, 0x22, 0xff, 0x0e, 0x86,
        0x0f, 0x32,
    ];
    /// `3c4zo42BrvpUj3EFftCPM77VxtZvRxNK7vHBFW5Y5Pmu`, the derived ProgramData.
    const PROGRAMDATA: [u8; 32] = [
        0x26, 0xb3, 0x38, 0x91, 0x69, 0xc5, 0x02, 0xea, 0x12, 0x67, 0x5f, 0x67, 0x46, 0x10, 0x7f,
        0xc1, 0x48, 0x77, 0x3b, 0x45, 0xc1, 0x85, 0xc3, 0x51, 0xa1, 0x6d, 0x1a, 0x9d, 0x94, 0x96,
        0x55, 0x94,
    ];
    ...
    const ELF_DIGEST: [u8; 32] = [
        0xd2, 0xff, 0x2b, 0x87, 0xac, 0x79, 0xe5, 0x32, 0x9b, 0x83, 0xf1, 0x0e, 0x10, 0xa2, 0xf2,
        0xd9, 0xb0, 0x3a, 0xc1, 0x6d, 0x44, 0x5d, 0x07, 0x01, 0x88, 0xf0, 0x39, 0x46, 0x59, 0x8d,
        0xa9, 0x1a,
    ];
    /// `0x1d70f546`, from bytes 4..12 of the ProgramData header.
    const DEPLOYMENT_SLOT: u64 = 493_942_086;
