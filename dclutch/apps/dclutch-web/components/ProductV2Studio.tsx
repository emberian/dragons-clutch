...
export default function ProductV2Studio() {
  ...
  return <main className="product-shell direct-workspace product-v2-studio">
    <ConsoleHeader path="/product-v2" title="Product studio" purpose="Write a payoff curve as exact fractions, compile the canonical record, and read back what each outcome pays." />
    <section className="market-heading"><div><h1>Product studio.</h1><p>The payoff is exact fractions — signed knot numerators over one shared denominator, with constant, ramp, and tent terms. Nothing is rounded until the one defined boundary: the final floor into payout atoms.</p></div></section>
    <form className="direct-card" onSubmit={compile}><div className="direct-card-heading"><span>01</span><div><h2>Compile one canonical Product V2 record</h2><p>Semantic data and its content identity. No market or deployment is implied.</p></div></div>
