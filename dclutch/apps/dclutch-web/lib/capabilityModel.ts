...
export const CAPABILITY_ACTIONS_V1: ReadonlyArray<CapabilityActionV1> = Object.freeze([
  ...
  action('market.found', 'author', 'Creation', 'Prepare the current founding campaign', 'rust-unsigned', '/found', false, 'The browser page inspects an older partial Found37 pair and cannot open a current devnet Market. The complete operator campaign owns the finalized prestates, compact atomic opening, journal, and recovery.'),
  ...
  action('direct.inline', 'trade', 'Direct', 'Inspect a Direct route and its arithmetic', 'awaiting-production', '/trade', true, 'The browser authenticates route state and previews exact integer effects, but it does not create an intent, signature, packet, or transaction. Mutation waits for the accepted caller, durable journal, authenticated acknowledgement, and exact finalized poststates.'),
