...
} from '@dclutch/sdk/generated/generalClearingPriceV1';
import {
...
} from '@dclutch/sdk/generated/generalOrderV2';
import {
...
const GENERAL_BATCH_STATUSES: ReadonlyArray<EnumTag> = Object.freeze([
  Object.freeze({ tag: GENERAL_BATCH_STATUS_COLLECTING_V2, name: 'Collecting' }),
  Object.freeze({ tag: GENERAL_BATCH_STATUS_CLOSED_V2, name: 'Closed' }),
  Object.freeze({ tag: GENERAL_BATCH_STATUS_CLEARED_V2, name: 'Cleared' }),
]);

/** What a clearing did with complete sets: nothing, minted them, or merged them. */
const GENERAL_CLEARING_MOVES: ReadonlyArray<EnumTag> = Object.freeze([
  Object.freeze({ tag: GENERAL_CLEARING_MOVE_NONE_V1, name: 'None' }),
  Object.freeze({ tag: GENERAL_CLEARING_MOVE_MINT_V1, name: 'Mint' }),
  Object.freeze({ tag: GENERAL_CLEARING_MOVE_MERGE_V1, name: 'Merge' }),
]);

/** Which side of the book one signed order is on. */
const GENERAL_ORDER_SIDES: ReadonlyArray<EnumTag> = Object.freeze([
  Object.freeze({ tag: GENERAL_ORDER_SIDE_BUY_V2, name: 'Buy' }),
  Object.freeze({ tag: GENERAL_ORDER_SIDE_SELL_V2, name: 'Sell' }),
]);

/** Where one maker order stands: resting, withdrawn, or paid out. */
const GENERAL_ORDER_STATES: ReadonlyArray<EnumTag> = Object.freeze([
  Object.freeze({ tag: GENERAL_ORDER_STATE_PLACED_V2, name: 'Placed' }),
  Object.freeze({ tag: GENERAL_ORDER_STATE_CANCELLED_V2, name: 'Cancelled' }),
  Object.freeze({ tag: GENERAL_ORDER_STATE_RELEASED_V2, name: 'Released' }),
]);
...
const RECORD_RENDERERS: ReadonlyArray<RecordSpec> = Object.freeze([
  ...
  },
  {
    ...
    width: {
      ...
      strideBytes: GENERAL_CLEARING_TAIL_COUNT_V1 * GENERAL_CLEARING_TAIL_STRIDE_V1,
      countOffset: GENERAL_BATCH_OUTCOME_COUNT_OFFSET_V2,
      countKind: 'u32',
      rowLabel: 'per-outcome clearing cell — one price and one stranded residual, in two separate runtime vectors rather than interleaved',
    },
    fields: [
      version(GENERAL_BATCH_VERSION_OFFSET_V2),
      field('Record tag', GENERAL_BATCH_PHASE_OFFSET_V2, 'enum', {
        tags: [{ tag: GENERAL_BATCH_PHASE_V2, name: 'Batch' }],
      }),
      field('Outcome count', GENERAL_BATCH_OUTCOME_COUNT_OFFSET_V2, 'u32'),
      field('Sequence', GENERAL_BATCH_SEQUENCE_OFFSET_V2, 'u64'),
      field('Generation', GENERAL_BATCH_GENERATION_OFFSET_V2, 'u64'),
      field('Market', GENERAL_BATCH_MARKET_OFFSET_V2, 'pubkey'),
      field('Product identity', GENERAL_BATCH_PRODUCT_ID_OFFSET_V2, 'identity'),
      field('Config identity', GENERAL_BATCH_CONFIG_ID_OFFSET_V2, 'identity'),
      field('Price scale', GENERAL_BATCH_PRICE_SCALE_OFFSET_V2, 'u64'),
      field('Collection closes at slot', GENERAL_BATCH_COLLECTION_CLOSE_SLOT_OFFSET_V2, 'u64'),
      field('Max orders', GENERAL_BATCH_MAX_ORDERS_OFFSET_V2, 'u32'),
      field('Settlement closes at slot', GENERAL_BATCH_SETTLEMENT_CLOSE_SLOT_OFFSET_V2, 'u64'),
      field('Status', GENERAL_BATCH_STATUS_OFFSET_V2, 'enum', { tags: GENERAL_BATCH_STATUSES }),
      field('Order count', GENERAL_BATCH_ORDER_COUNT_OFFSET_V2, 'u32'),
      field('Opened at root revision', GENERAL_BATCH_OPENED_ROOT_REVISION_OFFSET_V2, 'u64'),
      field('Closed at root revision', GENERAL_BATCH_CLOSED_ROOT_REVISION_OFFSET_V2, 'u64'),
      field('Committed quote reserve', GENERAL_BATCH_COMMITTED_QUOTE_RESERVE_OFFSET_V2, 'u64'),
      field('Cancelled count', GENERAL_BATCH_CANCELLED_COUNT_OFFSET_V2, 'u32'),
      field('Cleared by candidate', GENERAL_CLEARING_CLEARED_CANDIDATE_ID_OFFSET_V1, 'identity'),
      field('Cleared at slot', GENERAL_CLEARING_CLEARED_SLOT_OFFSET_V1, 'u64'),
      field('Complete-set move', GENERAL_CLEARING_SETS_MOVE_OFFSET_V1, 'enum', { tags: GENERAL_CLEARING_MOVES }),
      field('Reserved', GENERAL_CLEARING_RESERVED_MOVE_OFFSET_V1, 'reserved'),
      field('Complete-set quantity', GENERAL_CLEARING_SETS_QUANTITY_OFFSET_V1, 'u64'),
      field('Filled lots', GENERAL_CLEARING_FILLED_LOTS_OFFSET_V1, 'u64'),
  ...
  },
  {
    ...
    name: 'General order',
    family: 'General',
    summary: 'One maker order in a batch: which side and which outcome it takes, the most it will fill, and the most it will pay per lot. Admission escrows its worst case.',
    width: {
      kind: 'header-and-rows',
      headerBytes: GENERAL_ORDER_ROW_BASE_V2,
      strideBytes: GENERAL_ORDER_ROW_STRIDE_V2,
      countOffset: GENERAL_ORDER_OUTCOME_COUNT_OFFSET_V2,
      countKind: 'u32',
      rowLabel: 'per-outcome receive and deliver pair',
    },
    fields: [
      version(GENERAL_ORDER_VERSION_OFFSET_V2),
      field('Record tag', GENERAL_ORDER_PHASE_OFFSET_V2, 'enum', {
        tags: [{ tag: GENERAL_ORDER_PHASE_V2, name: 'Order' }],
      }),
      field('Outcome count', GENERAL_ORDER_OUTCOME_COUNT_OFFSET_V2, 'u32'),
      field('Nonce', GENERAL_ORDER_NONCE_OFFSET_V2, 'u64'),
      field('Min quote credit per lot', GENERAL_ORDER_MIN_QUOTE_CREDIT_PER_LOT_OFFSET_V2, 'u64'),
      field('Owner identity', GENERAL_ORDER_OWNER_ID_OFFSET_V2, 'identity'),
      field('Market', GENERAL_ORDER_MARKET_OFFSET_V2, 'pubkey'),
      field('Batch identity', GENERAL_ORDER_BATCH_ID_OFFSET_V2, 'identity'),
      field('Generation', GENERAL_ORDER_GENERATION_OFFSET_V2, 'u64'),
      field('Max lots', GENERAL_ORDER_MAX_LOTS_OFFSET_V2, 'u64'),
      field('Max quote debit per lot', GENERAL_ORDER_MAX_QUOTE_DEBIT_PER_LOT_OFFSET_V2, 'u64'),
      field('Valid until slot', GENERAL_ORDER_VALID_UNTIL_SLOT_OFFSET_V2, 'u64'),
      field('Side', GENERAL_ORDER_SIDE_OFFSET_V2, 'enum', { tags: GENERAL_ORDER_SIDES }),
      field('Reserved', GENERAL_ORDER_RESERVED_SHAPE_OFFSET_V2, 'reserved'),
      field('First outcome of the interval', GENERAL_ORDER_OUTCOME_LO_OFFSET_V2, 'u32'),
      field('Last outcome of the interval', GENERAL_ORDER_OUTCOME_HI_OFFSET_V2, 'u32'),
      field('Reserved', GENERAL_ORDER_RESERVED_TAIL_OFFSET_V2, 'reserved'),
      field('Claims per lot', GENERAL_ORDER_CLAIMS_PER_LOT_OFFSET_V2, 'u64'),
      field('State', GENERAL_ORDER_STATE_PHASE_OFFSET_V2, 'enum', { tags: GENERAL_ORDER_STATES }),
      field('Reserved', GENERAL_ORDER_RESERVED_STATE_OFFSET_V2, 'reserved'),
      field('Admitted at slot', GENERAL_ORDER_STATE_ADMITTED_SLOT_OFFSET_V2, 'u64'),
