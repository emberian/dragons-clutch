...
const RECORD_RENDERERS: ReadonlyArray<RecordSpec> = Object.freeze([
  ...
  },
  {
    ...
    family: 'Capability',
    summary: 'One controller’s ordered subset of capability funding, bound to the exact manifest that defines every row.',
    width: {
      kind: 'header-only',
    ...
    note: 'Rows remain opaque here because their count is the population count of the selected mask, not a directly encoded scalar. The generated ABI still states their exact width; the program authenticates each row against the immutable manifest before interpreting its compartments.',
  },
  {
