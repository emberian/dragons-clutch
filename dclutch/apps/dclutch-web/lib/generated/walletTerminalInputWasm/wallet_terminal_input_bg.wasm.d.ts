...
export const liability_basis_market_header_bytes_v2: () => number;
export const liability_basis_position_header_bytes_v2: () => number;
export const wallet_terminal_input_book_round_three_addresses_v1: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
export const wallet_terminal_input_book_round_two_addresses_v1: (a: number, b: number, c: number, d: number) => [number, number, number, number];
