...
Status: **PROVISIONAL — the ENSEMBLE note's two questions ruled by the
orchestrator on 2026-09-04 under ember's standing goal, with the ensemble
designed and unbuilt, and reversible at the cost §7 states**. The questions are
`docs/design/MECHANISM_ENSEMBLE_RESOLUTION_2026_09_04.md:499-538`; the design and
its sorry-free Lean landed at `ff4f3b142` (`GOAL.md:4764-4781`). Direction 4 of
the mechanism agenda, decision 0031.
