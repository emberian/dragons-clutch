...
| U-003 | General batch collection, candidate selection, materialization, distribution, expiry, and closure | unfinished physical convergence | Runtime-width Trading path with best-valid-candidate semantics and full terminal campaign |
...
| U-013 | Certified nonnegative liability bases beyond categorical | unfinished expansion | Two-claim ramp/complement theorem and kernel, exact partition sum, generalized solvency, terminal payout, and translation corpus |
