<!--
  ...
  Sources: census inventory; crates/dclutch-refusal-registry (bands, via the census inventory); tools/gauntlet/execution-evidence.json; checked census ledgers; tools/gauntlet/*/bindings
-->
# Refusal codes
...
A further 16 bindings
record an uncredited refusal claim.
...
| `0x6104` | `ProtocolParametersSbfErrorV1::FoundingAuthority` | The founder is not this program's current upgrade authority, or the founding body is not the genesis body under that authority. | -- | economics-custody | `programs/dclutch-custody-sbf/src/protocol_parameters_v1.rs:55` |
...
| `0x6106` | `ProtocolParametersSbfErrorV1::UnauthorizedGovernance` | The signer is not this record's governance authority. | -- | economics-custody | `programs/dclutch-custody-sbf/src/protocol_parameters_v1.rs:59` |
...
| `0x6109` | `ProtocolParametersSbfErrorV1::NoPendingProposal` | Nothing has been proposed. | -- | economics-custody | `programs/dclutch-custody-sbf/src/protocol_parameters_v1.rs:65` |
| `0x610A` | `ProtocolParametersSbfErrorV1::ProposalNotMatured` | The change delay has not elapsed. | -- | economics-custody | `programs/dclutch-custody-sbf/src/protocol_parameters_v1.rs:67` |
...
| `0x6202` | `UpkeepVaultSbfErrorV1::Vault` | The vault PDA, its owner, or its bytes refused, or it is unfounded. | -- | economics-custody | `programs/dclutch-custody-sbf/src/upkeep_vault_v1.rs:47` |
