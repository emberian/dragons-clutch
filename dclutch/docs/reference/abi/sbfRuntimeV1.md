<!--
  ...
  Sources: apps/dclutch-web/lib/generated/sbfRuntimeV1.ts (which is itself generated -- see its header below)
-->

# ABI: sbfRuntimeV1

Source module: `apps/dclutch-web/lib/generated/sbfRuntimeV1.ts`, whose own header reads:
...
| name | value |
| --- | ---: |
| `SBF_HEAP_FRAME_GRANULARITY_BYTES_V1` | 1,024 |
