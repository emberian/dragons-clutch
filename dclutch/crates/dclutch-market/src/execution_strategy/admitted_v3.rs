...
use crate::capability_program::hot_v3::{
...
use crate::execution_strategy::v2::AcceleratorTransportProfileV2;
...
/// six-account prefix in [`crate::execution_strategy::shadow_v3`] and does not use this frame at
...
pub struct AdmittedInvocationContextV3 {
    ...
    /// length-prefixed form defined in [`crate::execution_strategy::shadow_digest_v3`]. This
...
/// [`crate::execution_strategy::shadow_digest_v3::accelerator_caller_authority_digest_v1`], which
