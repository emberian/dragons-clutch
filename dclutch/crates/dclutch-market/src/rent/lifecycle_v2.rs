...
use crate::RetirementReceiptV1;

use crate::rent::{PUBKEY_BYTES, RENT_SYSVAR_ID, RefundAuthority, SYSTEM_PROGRAM_ID};
...
#[cfg(test)]
mod tests {
    use crate::{RetirementReceiptInputV1, RetirementReceiptV1};
