...
(
  ...
  lake env lean --run EmitCapabilityManifestV1Abi.lean rust > "$generated"
)

first_line=$(sed -n '1p' "$generated")
test "$first_line" = '// @generated by formal/dclutch-semantics/EmitCapabilityManifestV1Abi.lean; do not edit.'
