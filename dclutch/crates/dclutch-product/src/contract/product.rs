...
use crate::contract::capacity::{CapacityProfileId, CapacityProfileV1, MIN_PARTITION_CELLS};
use crate::contract::claim::CategoricalUnitV1;
use crate::contract::{ContentId, Error, Result, array, byte, content_id, put, require_zero};
...
/// Canonical finalized-record schema label for [`TermsV1`].
pub const PRODUCT_TERMS_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] = b"dclutch/schema/product-terms-v1";
/// SHA-256 identity of [`PRODUCT_TERMS_SCHEMA_RELEASE_PREIMAGE_V1`].
pub const PRODUCT_TERMS_SCHEMA_RELEASE_ID_V1: [u8; 32] = [
    0x05, 0xc7, 0x92, 0xef, 0x90, 0x9f, 0x05, 0x6c, 0xbb, 0x64, 0x45, 0x87, 0x4a, 0xb6, 0x3e, 0x33,
    0x60, 0x97, 0x87, 0x43, 0xe0, 0x18, 0x51, 0x8f, 0x59, 0x6c, 0x52, 0x73, 0x85, 0x0f, 0x4f, 0x71,
];
/// Canonical finalized-record schema label for [`OccurrenceV1`].
pub const PRODUCT_OCCURRENCE_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] =
    b"dclutch/schema/product-occurrence-v1";
/// SHA-256 identity of [`PRODUCT_OCCURRENCE_SCHEMA_RELEASE_PREIMAGE_V1`].
pub const PRODUCT_OCCURRENCE_SCHEMA_RELEASE_ID_V1: [u8; 32] = [
    0xdc, 0x39, 0xf5, 0x3e, 0x72, 0x31, 0x7a, 0x64, 0x0f, 0x9e, 0xa3, 0x63, 0x3e, 0xb8, 0x43, 0xe6,
    0xf0, 0xf7, 0xdc, 0x52, 0xc1, 0xe3, 0x49, 0xbd, 0x6e, 0x73, 0x6e, 0x69, 0x6f, 0xfd, 0x6e, 0xf5,
];
/// Canonical finalized-record schema label for [`InstanceV1`].
pub const PRODUCT_INSTANCE_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] =
    b"dclutch/schema/product-instance-v1";
/// SHA-256 identity of [`PRODUCT_INSTANCE_SCHEMA_RELEASE_PREIMAGE_V1`].
...
mod tests {
    use super::*;
    use crate::contract::capacity::{CapacityEnvelope, CapacityProfileV1Input};
    use crate::contract::claim::{CategoricalUnitV1, CategoricalUnitV1Input};
    use crate::contract::id;
