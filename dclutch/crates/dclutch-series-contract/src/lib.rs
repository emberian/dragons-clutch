...
/// Canonical finalized-record schema label for [`SeriesRecipeV1`].
pub const SERIES_RECIPE_SCHEMA_RELEASE_PREIMAGE_V3: &[u8] = b"dclutch/schema/series-recipe-v3";
/// SHA-256 identity of [`SERIES_RECIPE_SCHEMA_RELEASE_PREIMAGE_V3`].
...
/// Canonical finalized-record schema label for [`CapitalizationAggregateV1`].
pub const SERIES_AGGREGATE_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] =
    b"dclutch/schema/series-capitalization-aggregate-v1";
/// SHA-256 identity of [`SERIES_AGGREGATE_SCHEMA_RELEASE_PREIMAGE_V1`].
...
/// Canonical finalized-record schema label for [`DerivedOccurrenceV1`].
pub const SERIES_DERIVED_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] =
    b"dclutch/schema/series-derived-occurrence-v1";
/// SHA-256 identity of [`SERIES_DERIVED_SCHEMA_RELEASE_PREIMAGE_V1`].
...
/// Canonical finalized-record schema label for [`OccurrenceCapitalizationV1`].
pub const SERIES_CAPITALIZATION_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] =
    b"dclutch/schema/series-occurrence-capitalization-v1";
/// SHA-256 identity of [`SERIES_CAPITALIZATION_SCHEMA_RELEASE_PREIMAGE_V1`].
