...
fn run() -> Result<(), String> {
    ...
    match command.as_str() {
        ...
        | "verify-series-translation"
        | "inspect-series-translation" => series_translation_cli::run(&command, &mut flags),
