...
use dclutch_fractional_claim_contract::{
    ...
    FRACTIONAL_ROOT_MARKET_OFFSET_V1, FRACTIONAL_ROOT_PDA_SEED_V1,
    ...
    FRACTIONAL_ROOT_TERMS_OFFSET_V1, FractionalActionV1,
};
...
fn encode_lifecycle() -> Result<Vec<u8>, FractionalArtifactCompilerErrorV1> {
    ...
    let seeds = [
        LifecycleSeedInputV3::Literal(FRACTIONAL_ROOT_PDA_SEED_V1),
