...
pub use protocol_infrastructure::{
    ...
    PROTOCOL_INFRASTRUCTURE_GENESIS_RENT_PREIMAGE_V2, PROTOCOL_INFRASTRUCTURE_PROFILE_SCHEMA_ID_V1,
...
pub const EXECUTION_RELEASE_SET_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] =
    generated_capability_execution::EXECUTION_RELEASE_SET_SCHEMA_RELEASE_PREIMAGE_V1;
...
pub const EXECUTION_RELEASE_SET_SCHEMA_RELEASE_ID_V1: [u8; IDENTITY_BYTES] =
    generated_capability_execution::EXECUTION_RELEASE_SET_SCHEMA_RELEASE_ID_V1;
