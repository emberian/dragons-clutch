...
use super::{
    ...
    GUARD_SCALAR_EQ, HEADER_BYTES, IMMUTABLE_IDENTITY_BINDING_BYTES,
    IMMUTABLE_IDENTITY_BINDING_COUNT_OFFSET, MAGIC, MAGIC_OFFSET, MAX_SEED_BYTES,
    PLAN_AUTHENTICATE, PLAN_AUTHENTICATE_OR_CREATE, PLAN_CLOSE, PLAN_COUNT_OFFSET, PLAN_CREATE,
