...
use super::{
    ...
    NONZERO_U64_TAIL_ROWS_ARTIFACT_PROFILE, OP_PROJECT_DATA_DIGEST, OP_PROJECT_DATA_IDENTITY,
...
impl AccountEffectPermissionsV2 {
    ...
    /// [`crate::account_profile::lifecycle_v3::PlanEffectPermissionsV3`] is -- grants precisely
...
const _: () = {
    let mut mask = 0_u8;
    while mask <= crate::account_profile::EFFECT_PERMISSION_MASK {
        if mask & !crate::account_profile::EFFECT_PERMISSION_MASK == 0 {
...
mod tests {
    ...
    use super::*;
    use crate::account_profile::AccountObservationV1;
    ...
    fn trusted_current_slot_round_trips_and_cannot_be_projected_over() {
        ...
        assert_eq!(
            profile.writes_register(crate::account_profile::v2::ProjectionTargetV2 {
                kind: crate::account_profile::v2::ProjectionRegisterKindV2::Scalar,
                space: crate::account_profile::v2::ProjectionRegisterSpaceV2::Common,
                index: 0,
            }),
            Ok(true)
        );
        ...
        assert_eq!(
            profile.writes_register(crate::account_profile::v2::ProjectionTargetV2 {
                kind: crate::account_profile::v2::ProjectionRegisterKindV2::Identity,
                space: crate::account_profile::v2::ProjectionRegisterSpaceV2::Common,
                index: 0,
            }),
            Ok(false)
    ...
    fn trusted_executing_program_is_profile8_only_bounded_and_overwrite_safe() {
        ...
        assert!(
            profile
                .writes_register(crate::account_profile::v2::ProjectionTargetV2 {
                    kind: crate::account_profile::v2::ProjectionRegisterKindV2::Identity,
                    space: crate::account_profile::v2::ProjectionRegisterSpaceV2::Common,
                    index: 2,
                })
        ...
        for (offset, value, expected) in [
            ...
            (
                crate::account_profile::v2::TRUSTED_EXECUTING_PROGRAM_RESERVED_OFFSET,
                1,
                Error::InvalidTrustedExecutingProgram,
            ),
        ] {
    ...
    fn variable_data_route_alias_inherits_one_authenticated_representative() {
        ...
        *unauthenticated_representative
        ...
        crate::account_profile::v2::encode_project_data_u8_operation_v2(&mut u8_bytes, 0, 0, 11)
    ...
    fn dynamic_spans_shift_aliases_protect_widths_and_admit_opaque_data() {
        ...
        assert_eq!(output_scalars, input_scalars);
        assert_eq!(output_identities, input_identities);
        let mut permissions = [crate::effect::v2::AccountPermission::read_only(); 6];
