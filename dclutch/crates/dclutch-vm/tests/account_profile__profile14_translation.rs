...
#[path = "../src/account_profile/v2/generated_profile14.rs"]
mod generated;
...
fn every_lean_owned_predicate_kind_round_trips_through_rust() {
    ...
    encode_account_profile_with_fixed_data_predicates_v2_atomic(
        dclutch_vm::account_profile::v2::TrustedEnvironmentV2::None,
        dclutch_vm::account_profile::v2::TrustedIdentityEnvironmentV2::None,
        dclutch_vm::account_profile::v2::TrustedBuiltinIdentityV2::None,
        &[],
        &predicates,
        &[exact_rule(16)],
        &[],
