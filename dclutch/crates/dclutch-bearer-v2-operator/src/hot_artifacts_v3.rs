...
use dclutch_rational_representation_v2_contract::{
    ...
    RATIONAL_TERMINAL_HOT_ASSET_COEFFICIENT_OFFSET_V3, RATIONAL_TERMINAL_HOT_ASSET_EXPECTED_ACTOR_SHARDS_OFFSET_V3,
    ...
    RATIONAL_TERMINAL_HOT_REALM_OFFSET_V3, RATIONAL_TERMINAL_HOT_RECEIPT_MINT_OFFSET_V3, RATIONAL_TERMINAL_HOT_RELEASE_SET_OFFSET_V3,
    ...
    RATIONAL_TERMINAL_IDENTITY_ACTOR_V3, RATIONAL_TERMINAL_IDENTITY_COLLATERAL_RECIPIENT_V3, RATIONAL_TERMINAL_IDENTITY_DESCRIPTOR_V3,
