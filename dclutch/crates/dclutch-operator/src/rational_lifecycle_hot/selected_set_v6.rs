...
//! shippable ProgramSet builder, [`crate::rational_lifecycle_hot::build_rational_lifecycle_program_set_v5`],
...
pub(crate) mod tests {
    ...
    fn descriptor_width() -> usize {
        dclutch_claims::rational_kernel::DESCRIPTOR_HEADER_BYTES + COEFFICIENTS.len() * 8
    }
