...
mod tests {
    ...
    fn four_action_program_set_has_one_profiled_descriptor_per_action() {
        ...
        let build_selected = |action| {
            ...
            crate::rational_lifecycle_hot::build_rational_lifecycle_selected_bundle_v5(
                crate::rational_lifecycle_hot::RationalLifecycleSelectedBundleInputV5 {
                    action,
                    account_profile: crate::rational_lifecycle_hot::RationalLifecycleSelectedAccountProfileInputV5 {
                        logical_data_lengths: &lengths,
                        product_basis: &basis,
                    },
        ...
        let input = crate::rational_lifecycle_hot::RationalLifecycleProgramSetInputV5 {
            authenticated_token_behavior: authenticated,
