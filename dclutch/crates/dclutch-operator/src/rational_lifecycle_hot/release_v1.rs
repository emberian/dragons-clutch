...
//! [`crate::rational_lifecycle_hot::validate_rational_lifecycle_program_set_v6`], is a ROUND TRIP: it
...
mod tests {
    ...
    struct Release {
        set: crate::rational_lifecycle_hot::RationalLifecycleProgramSetV6,
