...
mod tests {
    ...
    fn compact_bundle<'a>(
        ...
        *lengths.get_mut(14).expect("descriptor") = u32::try_from(
        ...
        let bundle = crate::rational_lifecycle_hot::build_rational_lifecycle_compact_bundle_v4(
            crate::rational_lifecycle_hot::RationalLifecycleCompactBundleInputV4 {
                artifacts: crate::rational_lifecycle_hot::RationalLifecycleCompactArtifactInputV4 {
    ...
    fn state(fixed: &[AccountMeta]) -> RationalLifecycleHotStateV3<'_> {
        RationalLifecycleHotStateV3 {
            ...
            generation: 14,
            finalized_slot: 99,
            hot_outer: Some(crate::rational_lifecycle_hot::CheckedRationalLifecycleHotOuterV3 {
