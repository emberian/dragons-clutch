...
//! [`crate::bearer::validate_rational_open_capability_program_set_v3`], is a ROUND TRIP:
...
//!
//! [`crate::bearer::validate_rational_open_capability_program_set_v3`] does not read the
...
///
/// This is the order [`crate::bearer::build_rational_open_capability_program_set_v6`]
