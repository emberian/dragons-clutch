...
use crate::bearer::hot_account_profile_v3::{
    InjectedCoordinateV3, LogicalCoordinateV3, logical_coordinate, logical_index,
};
use crate::bearer::open_capability_set_v3::require_open_program_selection_v3;
use crate::bearer::{
...
pub fn build_rational_terminal_hot_instruction_v3(
    ...
    let built = build_profiled_hot_instruction_from_claims_child_v3(
        ...
        usize::from(crate::bearer::RATIONAL_TERMINAL_CLAIMS_ACCOUNT_COUNT_V3),
...
mod tests {
    ...
    fn terminal() -> ConstructedHotTerminalV3 {
        ...
        let child_width = usize::from(crate::bearer::RATIONAL_TERMINAL_CLAIMS_ACCOUNT_COUNT_V3);
        let child_rule = |index: usize| {
            crate::bearer::hot_account_profile_v3::declared(
    ...
    fn builds_unsigned_hot38_and_preserves_only_wallet_signer() {
        ...
        let aliases = (0..usize::from(crate::bearer::RATIONAL_TERMINAL_CLAIMS_ACCOUNT_COUNT_V3))
            .filter(|index| {
                crate::bearer::hot_account_profile_v3::declared(
                    logical_coordinate(index + INJECTED_ACCOUNTS).expect("child coordinate"),
                )
