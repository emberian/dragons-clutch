...
use crate::bearer::hot_transaction_v3::build_profiled_hot_instruction_from_claims_child_v3;
...
mod tests {
    ...
    fn state<'a>(fixed: &'a [AccountMeta]) -> RationalOpenStructuredHotStateV3<'a> {
        RationalOpenStructuredHotStateV3 {
            ...
            generation: 14,
            finalized_slot: 99,
            hot_outer: Some(crate::bearer::CheckedRationalHotOuterReleaseV3 {
    ...
    fn structured_builds_hot38_plus_exact_affine_child() {
        ...
        let artifacts = crate::bearer::test_open_fixture_v3::open_artifact_fixture_v3(
            key(9).to_bytes(),
            key(1).to_bytes(),
            OUTCOMES,
        );
