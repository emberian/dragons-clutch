...
use crate::representation_composition::native_categorical_v1::{
...
use crate::wallet_terminal_input::{
...
#[cfg(test)]
mod tests {
    use crate::wallet_terminal_payout::{hex32, pubkey};

    use super::*;

    fn coordinates() -> ProtocolCoordinatesV1 {
        let input = crate::wallet_terminal_payout::wire::tests::input();
