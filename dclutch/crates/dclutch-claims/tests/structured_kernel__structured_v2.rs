...
#[path = "structured_kernel__support/mod.rs"]
mod support;
...
impl StructuredTermsAdmission {
    fn unauthenticated(
        admission: dclutch_claims::structured_kernel::StructuredTermsAdmissionV2,
    ) -> dclutch_claims::structured_kernel::StructuredTermsAdmissionV2 {
        dclutch_claims::structured_kernel::StructuredTermsAdmissionV2 {
