...
/// `dclutch-trading::dealer` restates it the same way for the same reason.
...
// until something stops the next one from growing. `dclutch-trading::dealer` says
...
///
/// Mirrored from `crate::fractional_kernel::exposure_v2`, which refuses
