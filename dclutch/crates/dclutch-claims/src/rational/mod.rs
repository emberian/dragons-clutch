...
pub(crate) mod generated {
    pub(crate) use crate::rational_request::generated::*;
}
pub(crate) mod request {
    pub(crate) use crate::rational_request::{
        AssetV2, CallerRoleV2, RepresentationActionV2, RepresentationRequestV2, ResolvedRequestV2,
    };
}
#[allow(missing_docs)]
...
pub use crate::rational_kernel::RATIONAL_REPRESENTATION_AUTHORITY_SEED_V2;
pub use crate::rational_request::{
    ABSENT_REVISION, ASSET_BYTES_V3, AssetRowV2, AssetV2, CallerRoleV2, CoordinateIdentitiesV3,
    Error, OPEN_REPRESENTATION_HOT_MAGIC_V3, OPEN_REPRESENTATION_HOT_REQUEST_SCHEMA_ID_V3,
    OPEN_REPRESENTATION_HOT_REQUEST_SCHEMA_PREIMAGE_V3, OPEN_REPRESENTATION_HOT_VERSION_V3,
    OpenRepresentationHotRequestV3, PHYSICAL_ABI_VERSION_V3, RATIONAL_ASSET_ACCOUNT_COUNT_V2,
    RATIONAL_BASE_ACCOUNT_COUNT_V2, RATIONAL_TERMINAL_ACCOUNT_COUNT_V2, RECEIPT_BYTES_V2,
    RECEIPT_MAGIC_V2, REPRESENTATION_ASSET_COORDINATES_V2, REPRESENTATION_BASE_COORDINATES_V2,
    REPRESENTATION_FRAME_SPEC_V2, REPRESENTATION_TERMINAL_COORDINATES_V2, REQUEST_MAGIC_V2,
    REQUEST_SELECTED_HEADER_BYTES_V3, REQUEST_STRUCTURED_HEADER_BYTES_V3,
    REQUEST_TERMINAL_HEADER_BYTES_V3, RepresentationActionV2, RepresentationCoordinateV2,
    RepresentationFrameSpecV2, RepresentationRequestHeaderV2, RepresentationRequestV2,
    RepresentationSegmentV2, RequestClassV3, ResolvedRequestV2, Result,
};
pub use generated_hot_v3::{
    ...
    RATIONAL_TERMINAL_HOT_ASSET_OFFSET_V3, RATIONAL_TERMINAL_HOT_CALLER_ROLE_OFFSET_V3,
...
pub use hot_v3::{
    ...
    RATIONAL_TERMINAL_IDENTITY_TOKEN_PROGRAM_V3, RATIONAL_TERMINAL_SCALAR_ACTOR_SHARDS_V3,
    RATIONAL_TERMINAL_SCALAR_CLAIMS_MARKET_REVISION_V3, RATIONAL_TERMINAL_SCALAR_COEFFICIENT_V3,
...
pub use replay::{
    ...
    RATIONAL_REPLAY_CLOSE_VERSION_V1, RATIONAL_REPLAY_MAGIC_V2, RATIONAL_REPLAY_VERSION_V2,
    RationalReplayCloseRequestV1, RationalReplayV2,
};
...
/// and in `crate::protocol_position_v2` as the "rational
...
pub use crate::protocol_position_v2::{
