...
pub use generated_descriptor::{
    DESCRIPTOR_COEFFICIENT_BYTES, DESCRIPTOR_HEADER_BYTES, DESCRIPTOR_MAGIC_V3, DESCRIPTOR_MARKET_ID_OFFSET,
...
use generated_descriptor::{
    ...
    DESCRIPTOR_MAGIC_OFFSET, DESCRIPTOR_OUTCOME_COUNT_OFFSET,
...
impl<'a> RepresentationDescriptorV2<'a> {
    ...
    pub fn authenticate_exposure(
        self,
        exposure: crate::composition::CompositionExposureBundleV3<'_>,
    ) -> Result<()> {
