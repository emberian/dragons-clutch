...
use crate::composition::generated_abi as gen_abi;

use crate::composition::CompositionDescriptorV3;
...
impl<'a> CanonicalTranslationV3<'a> {
    ...
    fn validate_structural(self) -> Result<()> {
        if self.outcome_count < crate::composition::MIN_COMPOSITION_OUTCOMES_V3
            || self.outcome_count > crate::composition::MAX_COMPOSITION_OUTCOMES_V3
        {
...
pub fn composition_translation_bytes_v3(term_count: u32) -> Result<usize> {
    if term_count == 0 || term_count > crate::composition::MAX_COMPOSITION_TERMS_V3 {
