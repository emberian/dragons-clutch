...
use dclutch_product::economic_slice as slice;
...
///
/// `crates/dclutch-claims/src/founding_v5.rs:983-990` asserts
...
fn custody_itself_refuses_the_shapes_this_contract_is_careful_not_to_build() {
    use dclutch_custody::Error as CustodyError;
...
// `dclutch_product::economic_slice` and report what it actually does.
// ============================================================================
