...
use crate::structured::StructuredActionV2;
...
impl StructuredFrameSpecV2 {
    ...
    pub fn new(backed_coordinates: usize) -> Result<Self> {
        if backed_coordinates == 0
            || backed_coordinates > crate::structured::STRUCTURED_HOT_MAX_TOKEN_EFFECTS_V2 - 1
        {
...
mod tests {
    ...
    fn zero_width_and_over_capacity_widths_refuse() {
        ...
        let capacity = crate::structured::STRUCTURED_HOT_MAX_TOKEN_EFFECTS_V2 - 1;
