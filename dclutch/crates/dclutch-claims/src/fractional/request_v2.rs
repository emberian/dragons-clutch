...
use crate::fractional_kernel::FractionalExposureTermsV2;
...
/// Action discriminator offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_ACTION_OFFSET_V2: usize = 10;
/// Five-byte canonical reserved header offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_HEADER_RESERVED_OFFSET_V2: usize = 11;
/// Checked release-set identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_RELEASE_SET_OFFSET_V2: usize = 16;
/// Logical Market identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_MARKET_OFFSET_V2: usize = 48;
/// Finalized Product record identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_PRODUCT_RECORD_OFFSET_V2: usize = 80;
/// Product-owned result-domain identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_RESULT_DOMAIN_OFFSET_V2: usize = 112;
/// Finalized Fractional terms identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_TERMS_OFFSET_V2: usize = 144;
/// Finalized Token behavior selection identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_TOKEN_BEHAVIOR_OFFSET_V2: usize = 176;
/// Finalized Product-to-Claims exposure identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_EXPOSURE_OFFSET_V2: usize = 208;
/// Actor owner identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_OWNER_OFFSET_V2: usize = 240;
/// Source Token account identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_SOURCE_TOKEN_OFFSET_V2: usize = 272;
/// Destination Token account identity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_DESTINATION_TOKEN_OFFSET_V2: usize = 304;
/// Finalized terminal-coordinate digest offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_TERMINAL_DIGEST_OFFSET_V2: usize = 336;
/// Optimistic Fractional-root revision offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_EXPECTED_REVISION_OFFSET_V2: usize = 368;
/// Native Claims or raw shard quantity offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_QUANTITY_OFFSET_V2: usize = 376;
/// Selected representation coordinate offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_REPRESENTATION_COORDINATE_OFFSET_V2: usize = 384;
/// Twenty-eight-byte canonical reserved tail offset.
pub const FRACTIONAL_EXPOSURE_REQUEST_TAIL_RESERVED_OFFSET_V2: usize = 388;

const ACTION_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_ACTION_OFFSET_V2;
const HEADER_RESERVED_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_HEADER_RESERVED_OFFSET_V2;
const RELEASE_SET_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_RELEASE_SET_OFFSET_V2;
const MARKET_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_MARKET_OFFSET_V2;
const PRODUCT_RECORD_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_PRODUCT_RECORD_OFFSET_V2;
const RESULT_DOMAIN_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_RESULT_DOMAIN_OFFSET_V2;
const TERMS_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_TERMS_OFFSET_V2;
const TOKEN_BEHAVIOR_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_TOKEN_BEHAVIOR_OFFSET_V2;
const EXPOSURE_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_EXPOSURE_OFFSET_V2;
const OWNER_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_OWNER_OFFSET_V2;
const SOURCE_TOKEN_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_SOURCE_TOKEN_OFFSET_V2;
const DESTINATION_TOKEN_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_DESTINATION_TOKEN_OFFSET_V2;
const TERMINAL_DIGEST_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_TERMINAL_DIGEST_OFFSET_V2;
const EXPECTED_REVISION_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_EXPECTED_REVISION_OFFSET_V2;
const QUANTITY_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_QUANTITY_OFFSET_V2;
const REPRESENTATION_COORDINATE_OFFSET: usize =
    FRACTIONAL_EXPOSURE_REQUEST_REPRESENTATION_COORDINATE_OFFSET_V2;
const TAIL_RESERVED_OFFSET: usize = FRACTIONAL_EXPOSURE_REQUEST_TAIL_RESERVED_OFFSET_V2;
