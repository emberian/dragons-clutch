...
//!
//! [`DealerRootPhaseV1`] is the phase [`crate::root_tail::RootTail`] persists,
...
//! [`crate::Phase::tag`] -- the emitted authority itself, called in `const`
...
pub use crate::Phase as DealerRootPhaseV1;
...
///
/// [`crate::Phase::tag`] is the emitted authority, so this is not a second
