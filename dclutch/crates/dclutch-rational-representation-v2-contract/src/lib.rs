...
pub use dclutch_rational_representation_v2_request_contract::{
    ...
    OpenRepresentationHotRequestV3, PHYSICAL_ABI_VERSION_V2, RATIONAL_ASSET_ACCOUNT_COUNT_V2,
    ...
    REPRESENTATION_FRAME_SPEC_V2, REPRESENTATION_TERMINAL_COORDINATES_V2, REQUEST_HEADER_BYTES_V2,
