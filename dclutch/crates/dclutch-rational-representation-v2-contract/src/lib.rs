...
pub use dclutch_rational_representation_v2_request_contract::{
    ABSENT_REVISION, ASSET_BYTES_V3, AssetRowV2, AssetV2, CallerRoleV2,
    CoordinateIdentitiesV3, Error,
    ...
    REPRESENTATION_FRAME_SPEC_V2, REPRESENTATION_TERMINAL_COORDINATES_V2,
    REQUEST_SELECTED_HEADER_BYTES_V3, REQUEST_STRUCTURED_HEADER_BYTES_V3,
    REQUEST_TERMINAL_HEADER_BYTES_V3, RequestClassV3, ResolvedRequestV2,
    REQUEST_MAGIC_V2, RepresentationActionV2, RepresentationCoordinateV2,
    RepresentationFrameSpecV2, RepresentationRequestHeaderV2, RepresentationRequestV2,
    RepresentationSegmentV2, Result,
};
pub use generated_hot_v3::{
    ...
    RATIONAL_TERMINAL_HOT_ASSET_OFFSET_V3,
    ...
    RATIONAL_TERMINAL_HOT_QUANTITY_OFFSET_V3, RATIONAL_TERMINAL_HOT_REALM_OFFSET_V3, RATIONAL_TERMINAL_HOT_RECEIPT_MINT_OFFSET_V3,
...
pub use hot_v3::{
    ...
    RATIONAL_TERMINAL_SCALAR_ACTOR_SHARDS_V3, RATIONAL_TERMINAL_SCALAR_CLAIMS_MARKET_REVISION_V3,
