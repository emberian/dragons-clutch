...
fn quote() -> FundingQuoteV1 {
    let native = |value: u64| {
        dclutch_capability_contract::funding::CompartmentFundingV1::native_lamports(value)
            .expect("positive lamports")
    };
    let absent = dclutch_capability_contract::funding::CompartmentFundingV1::not_applicable();
    FundingQuoteV1::new(
...
) -> (dclutch_capability_contract::funding::AuthenticatedFundingLedgerV2<'a, 'a>,) {
