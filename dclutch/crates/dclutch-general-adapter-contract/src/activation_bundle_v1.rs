...
//!
//! [`crate::release_v3::authenticate_general_program_set_v3`] has admitted that
...
//! `dclutch-capability-activation-codec` compose everything else out of the
//! constants.
//!
...
/// [`crate::artifacts_v3::GENERAL_CONTROLLER_ACTION_SELECTOR_OFFSET_V3`], which
...
const ACTIVATION_COMMON_SCALARS: usize =
    dclutch_capability_program_contract::activation_registers_v2::ACTIVATION_COMMON_SCALARS_V2;
...
/// wrote with [`crate::release_v3::authenticate_general_program_set_v3`],
...
pub fn build_general_activation_capable_program_set_v1(
    ...
    let (set, authenticated) = crate::release_v3::authenticate_general_program_set_v3(
        digest_of_output,
        digest_of_output,
        &output,
    )
...
mod tests {
    ...
    fn the_request_schema_and_selector_are_frozen() {
        ...
        for action in crate::release_v3::GENERAL_ACTIONS_V4 {
