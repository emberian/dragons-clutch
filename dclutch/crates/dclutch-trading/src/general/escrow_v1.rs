...
//! [`crate::general::candidate_v1::GeneralCandidateV1::validate_capitalization`] compares
...
//! in the pure packet builder ([`crate::general::child_packets`]) and in the batch
//! record ([`crate::general::collection_v1`]). **It did not land in the artifact.**
//!
...
/// [`GeneralCandidateV1::validate_capitalization`](crate::general::candidate_v1::GeneralCandidateV1::validate_capitalization)
...
impl WorkEscrowFundingPlanV1 {
    ...
    /// [`GeneralCandidateV1::submit`](crate::general::candidate_v1::GeneralCandidateV1::submit)
...
impl WorkEscrowClosePlanV1 {
    ...
    /// [`GeneralCandidateV1::close_out`](crate::general::candidate_v1::GeneralCandidateV1::close_out)
