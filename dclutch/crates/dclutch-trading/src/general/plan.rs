...
impl EffectRecorderV2<'_> {
    fn record(
        &mut self,
        plan: core::result::Result<GeneralChildPlanV2<'_>, crate::general::Error>,
...
impl SettlementChildrenV1 for EffectRecorderV2<'_> {
    fn collect_claims(
        ...
        outcome_count: u8,
        quantities: &[u64; crate::general_codec::MAX_OUTCOMES],
    ) -> core::result::Result<(), ChildExecutionError> {
        self.record_row(
...
impl EffectRecorderV2<'_> {
    fn record_row(
        ...
        let mut tail = [0_u8; 8 * crate::general_codec::MAX_OUTCOMES];
    ...
    fn record_uniform_aggregate(
        ...
        let quantities = [quantity; crate::general_codec::MAX_OUTCOMES];
        let mut tail = [0_u8; 8 * crate::general_codec::MAX_OUTCOMES];
        let active = encode_quantities(outcome_count, &quantities, &mut tail)?;
...
fn encode_quantities<'a>(
    outcome_count: u8,
    quantities: &[u64; crate::general_codec::MAX_OUTCOMES],
    output: &'a mut [u8; 8 * crate::general_codec::MAX_OUTCOMES],
