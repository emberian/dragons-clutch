...
//! fact: the content identity of the exact [`crate::general_config::GeneralConfigV2`] preimage.
...
pub const GENERAL_ROOT_BYTES_V2: usize = crate::general_config::generated::GENERAL_ROOT_BYTES_V2;
...
pub const GENERAL_ROOT_MAGIC_WORD_V2: u64 =
    u64::from_le_bytes(crate::general_config::generated::GENERAL_ROOT_MAGIC_V2);
...
const _: () = {
    ...
    assert!(crate::general_config::generated::ROOT_RESERVED_HEADER_OFFSET == 11);
...
pub enum RootError {
    ...
    Config(crate::general_config::Error),
    /// Runtime-width V3 config bytes or immutable coordinates refused.
    ConfigV3(crate::general_config::v3::GeneralConfigErrorV3),
...
impl From<crate::general_config::Error> for RootError {
    fn from(value: crate::general_config::Error) -> Self {
        Self::Config(value)
    }
}

impl From<crate::general_config::v3::GeneralConfigErrorV3> for RootError {
    fn from(value: crate::general_config::v3::GeneralConfigErrorV3) -> Self {
        Self::ConfigV3(value)
    }
}
...
impl From<dclutch_market::capability_manifest::Error> for RootError {
    fn from(value: dclutch_market::capability_manifest::Error) -> Self {
...
impl GeneralRootV2 {
    ...
    pub fn decode(bytes: &[u8]) -> RootResult<Self> {
        ...
        if read_array::<8>(bytes, 0)? != crate::general_config::generated::GENERAL_ROOT_MAGIC_V2
            || read_u16(bytes, crate::general_config::generated::ROOT_VERSION_OFFSET)?
                != crate::general_config::generated::ABI_VERSION_V2
        {
    ...
    pub fn to_bytes(self) -> [u8; GENERAL_ROOT_BYTES_V2] {
        ...
        put(
            &mut output,
            crate::general_config::generated::ROOT_VERSION_OFFSET,
            &crate::general_config::generated::ABI_VERSION_V2.to_le_bytes(),
        );
        put(
            &mut output,
            crate::general_config::generated::ROOT_LIFECYCLE_OFFSET,
...
fn select_general_entry(
    manifest: CapabilityManifestV1<'_>,
    config_id: ContentId,
) -> RootResult<(u16, dclutch_market::capability_manifest::CapabilityEntryV1)> {
...
mod tests {
    ...
    fn config_for_program(capability_program_id: [u8; 32]) -> GeneralConfigV2 {
        GeneralConfigV2::new(crate::general_config::GeneralConfigV2Input {
