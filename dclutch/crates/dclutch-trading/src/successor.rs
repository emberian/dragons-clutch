...
/// `dclutch-market::protocol_parameters`, and 500 is that record's
...
pub const DIRECT_MAX_FEE_BASIS_POINTS_V1: u16 =
    dclutch_market::protocol_parameters::PROTOCOL_ABSOLUTE_FEE_CEILING_BASIS_POINTS_V1;
...
const _: () = assert!(
    DIRECT_FEE_DENOMINATOR_V1
        == dclutch_market::protocol_parameters::PROTOCOL_BASIS_POINT_DENOMINATOR_V1
);
