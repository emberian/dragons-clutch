...
use crate::{
    ...
    registered_creation_artifacts_v4::{
        ...
        REGISTERED_IDENTITY_MARKET_V4, REGISTERED_IDENTITY_MINT_V4,
        REGISTERED_IDENTITY_PARENT_REQUEST_V4, REGISTERED_IDENTITY_PAYER_V4,
        REGISTERED_IDENTITY_REALM_V4, REGISTERED_IDENTITY_RECORD_BENEFICIARY_V4,
        REGISTERED_IDENTITY_RECORD_STATE_V4, REGISTERED_IDENTITY_RELEASE_SET_V4,
        REGISTERED_IDENTITY_REQUEST_MAKER_V4, REGISTERED_IDENTITY_TOKEN_PROGRAM_V4,
        REGISTERED_IDENTITY_TRADING_PROGRAM_V4, REGISTERED_SCALAR_COLLATERAL_RESERVE_V4,
        REGISTERED_SCALAR_FEE_BPS_V4, REGISTERED_SCALAR_GENERATION_V4,
        REGISTERED_SCALAR_INTENT_MAGIC_V4, REGISTERED_SCALAR_LIFECYCLE_V4,
        REGISTERED_SCALAR_LIMIT_V4, REGISTERED_SCALAR_MAKER_BUMP_V4,
        REGISTERED_SCALAR_MAKER_LIVE_COUNT_AFTER_V4, REGISTERED_SCALAR_MAKER_MAGIC_V4,
        REGISTERED_SCALAR_MAKER_PRINCIPAL_V4, REGISTERED_SCALAR_MAKER_VERSION_V4,
        REGISTERED_SCALAR_MAXIMUM_V4, REGISTERED_SCALAR_MINIMUM_LIVE_NONCE_AFTER_V4,
        REGISTERED_SCALAR_NEXT_NONCE_AFTER_V4, REGISTERED_SCALAR_NONCE_V4,
        REGISTERED_SCALAR_OUTCOME_V4, REGISTERED_SCALAR_RECORD_BUMP_V4,
...
const REQUEST_BANK_BYTES: usize =
    2 * dclutch_custody::CUSTODY_REQUEST_BYTES_V1 + DELEGATED_CUSTODY_REQUEST_BYTES_V2;
...
fn encode_base_atomic(
    ...
    let routes = [
        route(
            ...
            dclutch_custody::INITIALIZE_REPLAY_ACCOUNT_COUNT_V1,
            &initialize,
        ),
