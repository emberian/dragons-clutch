...
pub const DIRECT_INLINE_ORDINARY_REQUEST_PROFILE_V1_BYTES_V3: usize =
    dclutch_vm::request_profile::HEADER_BYTES
        + INLINE_ORDINARY_REQUEST_OPERATIONS_V3 * dclutch_vm::request_profile::OPERATION_BYTES;
/// Exact signed RequestProfile V2 byte width.
pub const DIRECT_INLINE_ORDINARY_REQUEST_PROFILE_V2_BYTES_V3: usize =
    dclutch_vm::request_profile::v2::REQUEST_PROFILE_V2_HEADER_BYTES
        + DIRECT_INLINE_ORDINARY_REQUEST_PROFILE_V1_BYTES_V3
        + 2 * dclutch_vm::request_profile::v2::NATIVE_SIGNATURE_REQUIREMENT_BYTES_V1;
...
pub const DIRECT_INLINE_ORDINARY_REQUEST_PROFILE_ID_V3: [u8; 32] = [
    0x5f, 0x2c, 0x3c, 0x0f, 0x72, 0x87, 0xae, 0xe8, 0x18, 0x59, 0x75, 0x83, 0xdc, 0x17, 0x63, 0x89,
    0xaf, 0xd0, 0x4a, 0x6f, 0xf6, 0x32, 0x89, 0x44, 0x96, 0x7e, 0x2b, 0x55, 0xe6, 0x78, 0xc1, 0xe9,
];
...
pub const DIRECT_INLINE_ORDINARY_TRANSITION_ID_V3: [u8; 32] = [
    0x57, 0x84, 0xff, 0x32, 0x20, 0x71, 0x2c, 0x56, 0x7d, 0xae, 0x81, 0x96, 0x15, 0xea, 0x1d, 0x7c,
    0xc4, 0x52, 0xeb, 0x49, 0x1e, 0x3d, 0xc1, 0xc2, 0x8b, 0xdc, 0x20, 0xe0, 0x01, 0xaf, 0x41, 0x15,
];
...
pub const DIRECT_INLINE_ORDINARY_STRATEGY_ID_V3: [u8; 32] = [
    0x77, 0xd5, 0x8a, 0x4e, 0x41, 0x53, 0x18, 0xfe, 0x06, 0x65, 0xd4, 0xa3, 0x4e, 0x05, 0xf9, 0xd4,
    0x33, 0xcb, 0x1b, 0x9c, 0x84, 0x2a, 0xec, 0xac, 0x09, 0x44, 0x26, 0x0f, 0xec, 0xa5, 0x30, 0xfb,
];
...
mod tests {
    ...
    use dclutch_vm::request_profile::{ProjectionRegistersV1, v2::RequestProfileV2};
