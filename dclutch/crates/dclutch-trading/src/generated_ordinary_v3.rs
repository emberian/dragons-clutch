...
/// Derived non-terminal seller-net Custody route enable bit.
...
/// Program-owned venue fee band (decision 0014 D2), in basis points.
pub const SCALAR_MAX_FEE_BPS_V3: usize = 66;
/// Fee-continuation Custody route enable bit, program-pinned to zero: the fee leg settles in a second transaction.
pub const SCALAR_FEE_CONTINUATION_ROUTE_ENABLED_V3: usize = 67;
/// Program-owned sum of the seller floor and the buyer cap.
pub const SCALAR_LIMIT_SUM_V3: usize = 68;
/// Program-owned constant two, the RFQ's equal-split denominator.
pub const SCALAR_TWO_V3: usize = 69;
/// Program-owned derived RFQ price: the equal split of the two limits, rounded down; the request's execution price must equal it.
pub const SCALAR_DERIVED_PRICE_V3: usize = 70;
...
pub const DIRECT_ORDINARY_COMMON_SCALARS_V3: usize = 71;
...
pub const DIRECT_ORDINARY_PRELUDE_INSTRUCTIONS_V3: usize = 73;
...
pub const DIRECT_ORDINARY_TRANSITION_INSTRUCTIONS_V3: usize = 77;
/// Exact encoded ordinary TransitionVM V3 width.
pub const DIRECT_ORDINARY_TRANSITION_BYTES_V3: usize = 1880;
/// The exact ordinary TransitionVM V3 program.
pub const DIRECT_ORDINARY_TRANSITION_V3: [u8; DIRECT_ORDINARY_TRANSITION_BYTES_V3] = [
    0x44, 0x43, 0x54, 0x56, 0x03, 0x00, 0x49, 0x00, 0x03, 0x00, 0x01, 0x00, 0x47, 0x00, 0x02, 0x00,
    ...
    ,
    ...
    ,
