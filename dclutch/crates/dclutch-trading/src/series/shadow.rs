...
mod tests {
    ...
    struct Fixture {
        ...
        request: Vec<u8>,
        series_state: [u8; crate::series::replay::SERIES_STATE_BYTES_V3],
        ticket_state: [u8; crate::series::replay::SERIES_TICKET_STATE_BYTES_V3],
    ...
    impl Fixture {
        fn new() -> Self {
            ...
            let decoded_template = crate::series::TemplateV3::decode(&template).expect("Template");
    ...
    fn fixture_is_canonical_and_not_a_parallel_wire() {
        let fixture = Fixture::new();
        assert_eq!(
            crate::series::TemplateV3::decode(&fixture.template)
                .expect("Template")
                .occurrence_count(),
            3
        );
        assert_eq!(
            crate::series::admit_ticket(&fixture.ticket)
                .expect("Ticket")
                .ticket()
                .occurrence(),
            1
        );
        let projection = crate::series::future_market_projection(
            crate::series::admit_occurrence_bytes(
                &fixture.template,
                &fixture.occurrence,
