...
mod tests {
    ...
    fn one_kernel_admission_joins_request_template_occurrence_and_ticket() {
        let mut occurrence = crate::series::generated::SERIES_EXAMPLE_OCCURRENCE_V3;
        put(
            &mut occurrence,
            crate::series::generated::SERIES_OCCURRENCE_INDEX_OFFSET_V3,
            &0_u32.to_le_bytes(),
        );
        put(
            &mut occurrence,
        ...
        put(
            &mut template,
            crate::series::generated::SERIES_TEMPLATE_OCCURRENCE_COUNT_OFFSET_V3,
            &1_u32.to_le_bytes(),
        );
        put(
            &mut template,
            crate::series::generated::SERIES_TEMPLATE_PROJECTION_ROOT_OFFSET_V3,
            &occurrence_id.to_bytes(),
        );
        let template_id = crate::series::template_content_id(&template).expect("Template ID");

        let mut ticket = crate::series::generated::SERIES_EXAMPLE_TICKET_V3;
        put(
            &mut ticket,
            crate::series::generated::SERIES_TICKET_INDEX_OFFSET_V3,
            &0_u32.to_le_bytes(),
        );
        put(
            &mut ticket,
            crate::series::generated::SERIES_TICKET_TEMPLATE_OFFSET_V3,
            &template_id.to_bytes(),
        );
        put(
            &mut ticket,
            crate::series::generated::SERIES_TICKET_OCCURRENCE_ID_OFFSET_V3,
            &occurrence_id.to_bytes(),
        );
        let ticket_id = crate::series::admit_ticket(&ticket)
            .expect("Ticket ID")
            .content_id();
        ...
        *substituted
            .get_mut(crate::series::generated::SERIES_TICKET_FOUNDER_OFFSET_V3)
