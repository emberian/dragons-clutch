...
pub use generated_bands::{
    ...
    CUSTODY_REFUSAL_BASE, DEALER_ACCELERATOR_REFUSAL_BASE, DIRECT_AOT_REFUSAL_BASE,
    FIRST_PROGRAM_BAND, FIRST_TEST_BAND, GENERAL_ACCELERATOR_REFUSAL_BASE,
    PRODUCT_RUNTIME_V2_REFUSAL_BASE, PROGRAM_BAND_COUNT, REGISTRY_REFUSAL_BASE, RENT_REFUSAL_BASE,
    RESOLUTION_REFUSAL_BASE, SERIES_SHADOW_REFUSAL_BASE, TEST_CALLER_BAND_COUNT,
