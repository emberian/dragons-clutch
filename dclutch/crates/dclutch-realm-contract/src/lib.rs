...
pub const REALM_SCHEMA_RELEASE_PREIMAGE_V1: &[u8] = generated_abi::REALM_SCHEMA_RELEASE_PREIMAGE_V1;
/// SHA-256 identity of [`REALM_SCHEMA_RELEASE_PREIMAGE_V1`].
pub const REALM_SCHEMA_RELEASE_ID_V1: [u8; 32] = generated_abi::REALM_SCHEMA_RELEASE_ID_V1;
