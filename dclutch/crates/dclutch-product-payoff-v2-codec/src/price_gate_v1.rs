...
use crate::runtime_v3::{Error, Result};
use crate::spline_eval_v3::{SplineKnotsV3, apportion_cumulative_v3, evaluate_spline_weights_v3};
...
pub fn decode_price_gate_v1(input: &[u8]) -> Result<PriceGateCertificateV1> {
    ...
    if !(crate::runtime_v3::BASIS_SPLINE_MINIMUM_DEGREE_V3
        ..=crate::runtime_v3::BASIS_SPLINE_MAXIMUM_DEGREE_V3)
        .contains(&degree)
    {
