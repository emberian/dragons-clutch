...
generated_found_frame=$(mktemp "${TMPDIR:-/tmp}/dclutch-market-core-found-frame-rust.XXXXXX")
trap 'rm -f "$generated" "$generated_physical" "$generated_retirement" "$generated_found_frame"' EXIT HUP INT TERM
...
(
  ...
  lake build DClutchSemantics.CoreFoundFrameV3Abi
...
cmp "$generated_found_frame" "$crate_dir/src/generated_found_frame_v3.rs"
