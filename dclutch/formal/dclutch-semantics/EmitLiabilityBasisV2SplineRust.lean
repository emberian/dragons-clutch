...
def main : IO Unit := do
  ...
  IO.println s!"pub const SPLINE_MIN_DEGREE_V2: u8 = {minDegree};"
  IO.println s!"pub const SPLINE_MAX_DEGREE_V2: u8 = {maxDegree};"
  IO.println s!"pub const SPLINE_MAX_SUPPORT_V2: usize = {maxSupport};"
