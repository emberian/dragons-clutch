...
def main : IO Unit :=
  emit (header "EmitScoringRuleV1Ts.lean" "abi:scoring-rule") [
    ...
    [ ascii "RULE_MAGIC" ruleMagic,
      ...
      ascii "REDEEM_REQUEST_MAGIC" redeemRequestMagic,
      ascii "CLOSE_REQUEST_MAGIC" closeRequestMagic,
    ...
    [ nat "RULE_BYTES" ruleBytes,
      ...
      nat "REDEEM_REQUEST_BYTES" redeemRequestBytes,
      nat "CLOSE_REQUEST_BYTES" closeRequestBytes,
    ...
    offsets RedeemRequestFieldName redeemRequestLayout,
    offsets CloseRequestFieldName closeRequestLayout,
    ...
    [ nat "FUND_PHASE_OPEN" fundPhaseOpen.toNat,
      ...
      nat "ROUTE_REDEEM" routeRedeem.toNat,
      nat "ROUTE_CLOSE" routeClose.toNat ],
    frameSection "REDEEM" redeemFrame,
    frameSection "CLOSE" closeFrame,
