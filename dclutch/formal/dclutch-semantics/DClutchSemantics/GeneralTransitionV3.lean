...
/-- `GeneralBatchLayoutV2::magic_u64()` -- little-endian `DCGBAT02`.
...
def batchRecordMagicWord : Nat := 3616483140040082244
...
/-- `GeneralOrderLayoutV2::magic_u64()` -- little-endian `DCGORD02`.
...
def orderRecordMagicWord : Nat := 3616465621086585668
