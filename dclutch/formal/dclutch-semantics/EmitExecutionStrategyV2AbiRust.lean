...
def main : IO Unit := do
  ...
  IO.println s!"pub const EXECUTION_STRATEGY_RELEASE_ARTIFACT_PROFILE_V2: u16 = {releaseArtifactProfile};"
  IO.println s!"pub const EXECUTION_STRATEGY_SEMANTIC_ARTIFACT_PROFILE_V2: u16 = {semanticArtifactProfile};"
