...
def main : IO Unit := do
  ...
  emitBytesSkip "BASIS_MAGIC_V3" basisMagic
  ...
  emitSliceSkip "SEMANTIC_BASIS_CONTENT_DOMAIN_V3" semanticContentDomain
  emitSliceSkip "LINKED_BASIS_CONTENT_DOMAIN_V3" linkedContentDomain
