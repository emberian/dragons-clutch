...
def main : IO Unit := do
  ...
  emitBytesRows "pub" "SOURCE_RESOLUTION_STATE_V2_MAGIC" magic
  ...
  IO.println "#[cfg(test)]"
  emitBytesRows "pub(crate)" "SOURCE_RESOLUTION_STATE_V2_FRESH_EXAMPLE" (encode freshExample)
  IO.println "#[cfg(test)]"
  emitBytesRows "pub(crate)" "SOURCE_RESOLUTION_STATE_V2_WIDE_TERMINAL_EXAMPLE" (encode wideTerminalExample)
  IO.println "#[cfg(test)]"
