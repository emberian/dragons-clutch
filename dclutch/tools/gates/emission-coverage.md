...
| `crates/dclutch-claims/check-generated.sh` | shell | yes | `EmitClaimsConservationV1Rust.lean`, `EmitClaimsLiabilityBasisStateV2Rust.lean`, `EmitClaimsMarketClosureV1Rust.lean` |
...
| `crates/dclutch-custody/check-generated-upkeep-vault.sh` | shell | yes | `EmitUpkeepVaultV1Rust.lean` |
...
| `crates/dclutch-source/check-generated.sh` | shell | yes | `EmitEnsembleFoldReceiptV1AbiRust.lean`, `EmitParentReferenceV1Rust.lean`, `EmitSourceMaterialV2AbiRust.lean`, `EmitSourceMaterialV3AbiRust.lean`, `EmitSourcePrincipalCapacityV1Rust.lean`, `EmitSourceRecoveryPolicyV2AbiRust.lean`, `EmitSourceResolutionStateV2AbiRust.lean`, `EmitSourceScheduledMedianV1Rust.lean`, `EmitSourceStatisticSpecV1Rust.lean`, `EmitSourceWindowSpecV1Rust.lean` |
| `crates/dclutch-trading/check-generated-series.sh` | shell | yes | `EmitSeriesExpireFrameV5Rust.lean`, `EmitSeriesOccurrenceV3Rust.lean`, `EmitSeriesStateV3Rust.lean`, `EmitSeriesTicketStateV3Rust.lean` |
| `crates/dclutch-trading/check-generated.sh` | shell | yes | `EmitDirectCodecRust.lean`, `EmitRegisteredDirect.lean` |
| `crates/dclutch-trading/check-successor-generated.sh` | shell | yes | `EmitDirectIntentV2Rust.lean`, `EmitDirectIntentV3Rust.lean`, `EmitDirectOrdinaryV3Rust.lean`, `EmitDirectRegisteredFillV4Rust.lean`, `EmitDirectSuccessorAbiRust.lean` |
...
| `crates/dclutch-trading/tests/general__clearing_price_v1_generator_fresh.rs` | cargo-test | yes | `EmitClearingPriceV1AbiRust.lean` |
| `crates/dclutch-trading/tests/general__order_v2_generator_fresh.rs` | cargo-test | yes | `EmitGeneralOrderV2AbiRust.lean` |
...
| `crates/dclutch-trading/tests/scoring_rule__generator_fresh.rs` | cargo-test | yes | `EmitScoringRuleV1Rust.lean` |
...
| `crates/dclutch-vm/tests/effect__effect_v5_lean_generator_fresh.rs` | cargo-test | yes | `EmitEffectProgramV5AbiRust.lean` |
...
| `packages/dclutch-sdk: lean-emit EmitScoringRuleV1Ts.lean` | lean-emit | n/a | `EmitScoringRuleV1Ts.lean` |
...
| `crates/dclutch-claims/src/generated_conservation_v1.rs` | `EmitClaimsConservationV1Rust.lean` |
...
| `crates/dclutch-custody/src/generated_upkeep_vault_v1.rs` | `EmitUpkeepVaultV1Rust.lean` |
...
| `crates/dclutch-source/src/generated_ensemble_fold_receipt_v1.rs` | `EmitEnsembleFoldReceiptV1AbiRust.lean` |
| `crates/dclutch-source/src/generated_parent_reference_v1.rs` | `EmitParentReferenceV1Rust.lean` |
...
| `crates/dclutch-trading/src/general/generated_clearing_price_v1.rs` | `EmitClearingPriceV1AbiRust.lean` |
| `crates/dclutch-trading/src/general/generated_order_v2.rs` | `EmitGeneralOrderV2AbiRust.lean` |
...
| `crates/dclutch-trading/src/generated_intent_v3.rs` | `EmitDirectIntentV3Rust.lean` |
...
| `crates/dclutch-trading/src/scoring_rule/generated_scoring_rule.rs` | `EmitScoringRuleV1Rust.lean` |
| `crates/dclutch-trading/src/series/generated.rs` | `EmitSeriesOccurrenceV3Rust.lean` |
| `crates/dclutch-trading/src/series/generated_expire_frame_v5.rs` | `EmitSeriesExpireFrameV5Rust.lean` |
| `crates/dclutch-trading/src/series/generated_series_state_v3.rs` | `EmitSeriesStateV3Rust.lean` |
...
| `crates/dclutch-vm/src/effect/generated_v5_abi.rs` | `EmitEffectProgramV5AbiRust.lean` |
...
| `packages/dclutch-sdk/lib/generated/scoringRuleV1.ts` | `EmitScoringRuleV1Ts.lean` |
