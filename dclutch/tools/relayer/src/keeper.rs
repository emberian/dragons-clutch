...
const fn role_name(name: RelayAccountNameV1) -> &'static str {
    match name {
        ...
        RelayAccountNameV1::StatisticSpec => "statisticSpec",
        RelayAccountNameV1::StatisticSpecStagingVacancy => "statisticSpecStagingVacancy",
        RelayAccountNameV1::RecoveryPolicy => "recoveryPolicy",
        RelayAccountNameV1::RecoveryPolicyStagingVacancy => "recoveryPolicyStagingVacancy",
