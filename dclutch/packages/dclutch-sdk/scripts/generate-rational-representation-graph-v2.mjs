 ...
 * `crates/dclutch-rational-representation-v2-kernel/src/lib.rs` and nowhere
...
const sourcePath = new URL('crates/dclutch-rational-representation-v2-kernel/src/lib.rs', root);
