...
output += '   *\n';
output += '   * `null` for seven of the eight: their addresses come out of a route\n';
output += '   * manifest or a request, not out of a Market. The Source state is the\n';
output += '   * exception -- `[domain, market, generation]` under the Resolution\n';
output += '   * program -- which is why a reader holding one Market can read it and\n';
output += '   * nothing else here.\n';
output += '   */\n';
