...
const assertions = [
  // The V2 magic is Lean-owned since the promotion: the V2 codec reads it from
  // the V3 module's emission, and so does this.
  ['request', 'const MAGIC: [u8; 8] = REQUEST_V2_MAGIC;'],
  ['requestV3Generated', 'pub(crate) const REQUEST_V2_MAGIC: [u8; 8] = [0x44, 0x43, 0x47, 0x52, 0x45, 0x51, 0x30, 0x32];'],
  ['request', 'const VERSION: u16 = REQUEST_V2_ABI_VERSION;'],
  ['requestV3Generated', 'pub(crate) const REQUEST_V2_ABI_VERSION: u16 = 2;'],
  ...
  ['request', 'expected_revision: read_u64(input, REQUEST_V2_EXPECTED_REVISION_OFFSET)?'],
  ['requestV3Generated', 'pub(crate) const REQUEST_V2_EXPECTED_REVISION_OFFSET: usize = 16;'],
  ['request', 'let raw_candidate = read_array32(input, REQUEST_V2_CANDIDATE_ID_OFFSET)?'],
  ['requestV3Generated', 'pub(crate) const REQUEST_V2_CANDIDATE_ID_OFFSET: usize = 24;'],
  ['request', 'page_index: read_u32(input, REQUEST_V2_PAGE_INDEX_OFFSET)?'],
  ['requestV3Generated', 'pub(crate) const REQUEST_V2_PAGE_INDEX_OFFSET: usize = 56;'],
  ['request', 'execution_index: byte(input, REQUEST_V2_EXECUTION_INDEX_OFFSET)?'],
...
for (const [name, value] of [
  ...
  ['GENERAL_REQUEST_BYTES_V2', scalar('requestV3Generated', 'REQUEST_V2_BYTES')],
  ['GENERAL_REQUEST_ACTION_OFFSET_V2', scalar('requestV3Generated', 'REQUEST_V2_ACTION_OFFSET')],
  ['GENERAL_REQUEST_MANIFEST_ORDER_OFFSET_V2', scalar('requestV3Generated', 'REQUEST_V2_MANIFEST_ORDER_OFFSET')],
  ['GENERAL_REQUEST_STATE_BUMP_OFFSET_V2', scalar('requestV3Generated', 'REQUEST_V2_STATE_BUMP_OFFSET')],
  ['GENERAL_REQUEST_TERMINAL_BUMP_OFFSET_V2', scalar('requestV3Generated', 'REQUEST_V2_TERMINAL_BUMP_OFFSET')],
