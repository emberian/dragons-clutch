...
// RELATIVE, not `@/`. The alias is the bundler's, and this module is one
// half of a twin: `packages/dclutch-sdk` states in its own vitest config that
// "an import that needs [an alias] is an import that would break a consumer",
// because the package's exports map points at these very files. So the one
// aliased import here was the whole reason this file could not have a second
// home, and a relative specifier resolves identically in both trees.
