...
export const CAPABILITY_ACTIONS_V1: ReadonlyArray<CapabilityActionV1> = Object.freeze([
  ...
  action('market.join', 'author', 'Creation', 'Admit another participant', 'market-detail', true,
    anchors('components/JoinPanel.tsx', null, 'components/JoinPanel.tsx'),
    'The page reads your participant accounts and nothing else; the published command plans read-only until you add its execution flag.'),
