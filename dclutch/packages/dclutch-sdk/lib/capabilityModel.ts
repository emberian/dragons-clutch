...
export const CAPABILITY_ACTIONS_V1: ReadonlyArray<CapabilityActionV1> = Object.freeze([
  ...
  action('direct.inline', 'trade', 'Direct', 'Inspect a Direct route and its arithmetic', 'awaiting-production', '/trade', true, 'The public client authenticates route state and previews exact integer effects, but it does not create a packet or transaction. Mutation waits for the accepted caller, durable journal, authenticated acknowledgement, and exact finalized poststates.'),
