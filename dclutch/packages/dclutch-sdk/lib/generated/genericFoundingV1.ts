...
export const GENERIC_FOUNDING_LOCK_RAW_INDEX_V1 = 1 as const;
export const GENERIC_FOUNDING_REALIZE_RAW_INDEX_V1 = 2 as const;
...
export const GENERIC_FOUNDING_REQUEST_MAGIC_V1 = 'DCLTGFQ1' as const;
export const GENERIC_FOUNDING_ACK_MAGIC_V1 = 'DCLTGFA1' as const;
export const GENERIC_FOUNDING_REQUEST_BYTES_V1 = 400 as const;
export const GENERIC_FOUNDING_ACK_BYTES_V1 = 248 as const;
export const PROJECTED_CUSTODY_REQUEST_BYTES_V1 = 768 as const;
export const CLAIMS_FOUNDING_REQUEST_BYTES_V5 = 832 as const;
export const GENERIC_FOUNDING_MAX_FUNDING_STATES_V1 = 16 as const;
export const GENERIC_FOUNDING_REQUEST_MAGIC_OFFSET_V1 = 0 as const;
export const GENERIC_FOUNDING_ACK_MAGIC_OFFSET_V1 = 0 as const;

/** `GenericFoundingRequestV1` byte layout. */
export const GENERIC_FOUNDING_REQUEST_VERSION_V1 = 1 as const;
export const GENERIC_FOUNDING_REQUEST_VERSION_OFFSET_V1 = 8 as const;
export const GENERIC_FOUNDING_REQUEST_STAGE_OFFSET_V1 = 10 as const;
export const GENERIC_FOUNDING_REQUEST_FUNDING_COUNT_OFFSET_V1 = 11 as const;
export const GENERIC_FOUNDING_REQUEST_HEAD_RESERVED_OFFSET_V1 = 12 as const;
export const GENERIC_FOUNDING_REQUEST_HEAD_RESERVED_BYTES_V1 = 4 as const;
export const GENERIC_FOUNDING_REQUEST_IDENTITIES_OFFSET_V1 = 16 as const;
export const GENERIC_FOUNDING_REQUEST_SCALARS_OFFSET_V1 = 336 as const;
export const GENERIC_FOUNDING_REQUEST_ENTRY_INDEX_OFFSET_V1 = 392 as const;
export const GENERIC_FOUNDING_REQUEST_TAIL_RESERVED_OFFSET_V1 = 394 as const;
export const GENERIC_FOUNDING_REQUEST_TAIL_RESERVED_BYTES_V1 = 6 as const;
export const GENERIC_FOUNDING_ACK_IDENTITIES_OFFSET_V1 = 16 as const;
...
export const LOCAL_PROTOCOL_COMPUTE_UNIT_LIMIT_V1 = 1400000 as const;
export const FOUNDING_HEAP_FRAME_BYTES_V1 = 262144 as const;

/** Preimage domain of the ordered FundingState address list. */
export const GENERIC_FOUNDING_FUNDING_LIST_DOMAIN_V1 = new TextEncoder().encode('dclutch/generic-founding-funding-list/v1');
