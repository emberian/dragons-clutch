...
realization binds its exact Product, result domain, resolution policy,
...
namespace DClutch.SeriesOccurrenceV2
...
def Occurrence.valid
  ...
  value.scheduledSlot = DClutch.SeriesOccurrenceV2.scheduledSlot template value.occurrence &&
  [value.productId, value.resultDomainId, value.resolutionPolicyId,
...
end DClutch.SeriesOccurrenceV2
