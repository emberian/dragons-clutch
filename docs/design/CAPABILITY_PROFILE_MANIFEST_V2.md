...
| `runtime-real-pyth-release` | none | Checked release identity for a separately authenticated SourceReleaseManifestV2/real-Pyth route; it compiles no fixture row. |
