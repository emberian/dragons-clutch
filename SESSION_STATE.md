...
| CORESTATE-2 | `a1151a64b6bfa9895` | resumed: fix the 7 stack diagnostics without moving the pinned layout + gate role-link builds on the diagnostic (proven red-then-green). |
