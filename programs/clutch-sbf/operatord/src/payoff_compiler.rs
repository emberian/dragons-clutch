...
mod tests {
    ...
    fn historical_payoff_endpoint_and_request_schema_are_fail_closed() {
        ...
        assert!(api("/v1/compiler/product-exact-market", b"{}").is_none());
        ...
        let withdrawn_bundle_v5 = json!({
            "schema": "dragons-clutch/compiler/product-exact-market-request/v1",
            "expectedCompilerReleaseSha256": release(),
            "programId": "11111111111111111111111111111112",
            "definition": {},
            "bundleInputs": {
                "seriesFundingQuoteV4BytesHex": "",
                "seriesAttachmentPlanV4BytesHex": ""
            },
        });
        assert!(service
            .compile_request(withdrawn_bundle_v5.to_string().as_bytes())
            .is_err());
    }
