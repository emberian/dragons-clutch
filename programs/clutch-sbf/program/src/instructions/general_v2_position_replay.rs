...
use super::collateral_position_v3::{
    ...
    authenticate_general_position_replay_v3, GeneralPositionReplayAuthorityV1,
    GeneralPositionReplayAuthorityV2, GeneralPositionReplayAuthorityV3, RuntimeSha256,
};
