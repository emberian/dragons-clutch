//! `Intent::PlaceOrder`, `Intent::CancelOrder`, `Intent::SettlePage`, the
//! staged checkpoint creation pair
...
//! | retired `SubmitDirectPage` | **decode-only**: no current route or handler; Direct `80/1` owns its replacement lifecycle |
