...
pub fn authenticate_compiled_product_series_bundle_v1(
    ...
    let expected = reconstruct_compiled_product_series_bundle_v1(
        registry.projection(),
        source_release,
        artifacts,
    )?;
...
/// Reopen compiler output for a value-bearing registered-Series transition.
pub fn authenticate_registered_compiled_product_series_bundle_v1(
    program_id: &Pubkey,
    bundle_artifact: &AccountInfo<'_>,
    registry: AuthenticatedRegistryCapabilityV2,
    source_release: AuthenticatedSourceReleaseV1,
