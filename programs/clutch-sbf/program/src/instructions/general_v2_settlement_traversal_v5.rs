...
//! exact retained Feed, complete canonical V5 page set, current MarketBinding V4,
...
pub struct SettlementTraversalAccountFrameV5<'a, 'info> {
    ...
    /// Immutable current MarketBinding V4 PDA.
...
impl AuthenticatedSettlementTraversalV5<'_> {
    /// Exact current MarketBinding V4 body.
    pub const fn market(&self) -> &MarketBindingV4 {
        &self.market
    }
