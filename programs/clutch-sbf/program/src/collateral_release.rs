...
///
/// The local-real and Structured custody laboratory ELFs have binary-pinned
/// Token-2022 and legacy SPL rows plus synthesized deployment manifests without
/// fixture-account builders. Default artifacts have no rows. A public/devnet
/// artifact can select only the separately reviewed observed-positive manifest
/// compiled into that exact ELF; the checked repository manifest is currently
/// empty.
