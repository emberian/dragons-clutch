...
def main() -> None:
    ...
    document = {
        ...
        "builder": {
            ...
            "source_checkout_path_sha256": hashlib.sha256(str(repo).encode()).hexdigest(),
            "reproducibility_scope": (
                "two fresh target directories under one source checkout; Cargo path-dependency "
                "crate disambiguators remain checkout-path sensitive"
            ),
        },
        "rent_model": {
