...
pub const CANONICAL_ACCOUNT_DECODER_SET: &str =
    "dragons-clutch/canonical-account-decoders/v9-source-work-schedule-general-v3-historical-no-keeper-no-selected-candidate-direct-80-v2-product-global-current";
