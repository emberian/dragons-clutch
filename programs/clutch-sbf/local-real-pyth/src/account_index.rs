...
pub const CANONICAL_ACCOUNT_DECODER_SET: &str =
    "dragons-clutch/canonical-account-decoders/v8-current-failure-action11-frontier";
...
impl CanonicalAccountKind {
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::FailureIntervalConsensusWork => "failure-market-interval-cell-v2",
            Self::FailureIntervalConsensusReplay => "failure-market-interval-history-v2",
