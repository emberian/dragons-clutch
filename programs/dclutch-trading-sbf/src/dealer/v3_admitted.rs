...
use super::{
    ...
    v3_trade_artifacts::{
        ...
        DEALER_SCENARIO_DEALER_EVIDENCE_COUNT_SCALAR_V4, DEALER_SCENARIO_EXPIRY_SCALAR_V4,
        DEALER_SCENARIO_OBLIGATION_IDENTITY_V4, DEALER_SCENARIO_POSITION_COUNT_SCALAR_V4,
        DEALER_SCENARIO_POSITION_GEOMETRY_SUM_SCALAR_V4, DEALER_SCENARIO_WITNESS_BYTES_SCALAR_V4,
