...
//! [`bind_structured_child_descriptor_v2`](crate::bind_structured_child_descriptor_v2)
...
/// [`StructuredChildDescriptorV2`](crate::StructuredChildDescriptorV2)'s
/// coordinates are.
...
pub fn structured_child_descriptor_from_derivation_v2(
    ...
    authority: StructuredDescriptorAuthorityV2,
) -> Result<crate::StructuredChildDescriptorV2> {
    let descriptor = crate::StructuredChildDescriptorV2 {
    ...
    crate::bind_structured_child_descriptor_v2(terms, descriptor)?;
    Ok(descriptor)
}
