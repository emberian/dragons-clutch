...
const STATE_GENERATION_OFFSET: usize = 240;
const STATE_OUTSTANDING_CAPABILITIES_OFFSET: usize = 248;
const STATE_RENT_BENEFICIARY_OFFSET: usize = 256;
const STATE_TERMINAL_RECEIPT_OFFSET: usize = 288;
