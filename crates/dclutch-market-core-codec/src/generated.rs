...
pub const STATE_BYTES: usize = 1416;
pub const REQUEST_BYTES: usize = 72;
pub const ACTION_FOUND_TAG: u8 = 0;
pub const ACTION_ACTIVATE_FUND_TAG: u8 = 1;
pub const ACTION_OPEN_MARKET_TAG: u8 = 2;
pub const ACTION_ADMIT_TERMINAL_TAG: u8 = 3;
pub const ACTION_SPLIT_TAG: u8 = 4;
pub const ACTION_REDEEM_TAG: u8 = 5;
pub const ACTION_BEGIN_RETIRING_TAG: u8 = 6;
...
pub const PHASE_RETIRING_TAG: u8 = 3;
pub const PHASE_RETIRED_TAG: u8 = 4;
pub const READINESS_PREPAID_TAG: u8 = 0;
pub const READINESS_READY_TAG: u8 = 1;
pub const READINESS_CONSUMED_TAG: u8 = 2;
pub const HOLDER_NONE_TAG: u8 = 0;
pub const HOLDER_SOURCE_TAG: u8 = 1;
pub const HOLDER_DESTINATION_TAG: u8 = 2;
...
pub const STATE_MAGIC: [u8; 8] = [
    0x44, 0x43, 0x4c, 0x54, 0x43, 0x4f, 0x52, 0x31,
];
pub const REQUEST_MAGIC: [u8; 8] = [
    0x44, 0x43, 0x4c, 0x54, 0x43, 0x52, 0x51, 0x31,
];
const STATE_MAGIC_OFFSET: usize = 0;
const STATE_VERSION_OFFSET: usize = 8;
const STATE_PHASE_OFFSET: usize = 10;
const STATE_READINESS_OFFSET: usize = 11;
const STATE_TERMINAL_WINNER_OFFSET: usize = 12;
const STATE_REALM_ID_OFFSET: usize = 16;
const STATE_COLLATERAL_MINT_OFFSET: usize = 48;
const STATE_TOKEN_PROGRAM_OFFSET: usize = 80;
const STATE_COLLATERAL_RELEASE_OFFSET: usize = 112;
const STATE_PRODUCT_ID_OFFSET: usize = 144;
const STATE_RESULT_DOMAIN_OFFSET: usize = 176;
const STATE_CLAIM_BASIS_OFFSET: usize = 208;
const STATE_CAPACITY_PROFILE_OFFSET: usize = 240;
const STATE_COMPILER_RELEASE_OFFSET: usize = 272;
const STATE_OUTCOME_COUNT_OFFSET: usize = 304;
const STATE_PRODUCT_RESERVED_OFFSET: usize = 308;
const STATE_SCALAR_LIMIT_OFFSET: usize = 312;
const STATE_MARKET_ID_OFFSET: usize = 320;
const STATE_IDENTITY_REALM_OFFSET: usize = 352;
const STATE_IDENTITY_PRODUCT_OFFSET: usize = 384;
const STATE_IDENTITY_RESULT_DOMAIN_OFFSET: usize = 416;
const STATE_RESOLUTION_POLICY_OFFSET: usize = 448;
const STATE_SELECTED_RELEASE_SET_OFFSET: usize = 480;
const STATE_GENERATION_OFFSET: usize = 512;
const STATE_RELEASE_SET_ID_OFFSET: usize = 520;
const STATE_CORE_PROGRAM_OFFSET: usize = 552;
const STATE_CORE_ARTIFACT_OFFSET: usize = 584;
const STATE_CORE_SEMANTIC_OFFSET: usize = 616;
const STATE_CLAIMS_PROGRAM_OFFSET: usize = 648;
const STATE_CLAIMS_ARTIFACT_OFFSET: usize = 680;
const STATE_CLAIMS_SEMANTIC_OFFSET: usize = 712;
const STATE_TRADING_PROGRAM_OFFSET: usize = 744;
const STATE_TRADING_ARTIFACT_OFFSET: usize = 776;
const STATE_TRADING_SEMANTIC_OFFSET: usize = 808;
const STATE_RESOLUTION_PROGRAM_OFFSET: usize = 840;
const STATE_RESOLUTION_ARTIFACT_OFFSET: usize = 872;
const STATE_RESOLUTION_SEMANTIC_OFFSET: usize = 904;
const STATE_CUSTODY_PROGRAM_OFFSET: usize = 936;
const STATE_CUSTODY_ARTIFACT_OFFSET: usize = 968;
const STATE_CUSTODY_SEMANTIC_OFFSET: usize = 1000;
const STATE_DERIVATION_AUTHENTICATED_OFFSET: usize = 1032;
const STATE_COORDINATE_RESERVED_OFFSET: usize = 1033;
const STATE_COORDINATE_MARKET_OFFSET: usize = 1040;
const STATE_COORDINATE_HOARD_OFFSET: usize = 1072;
const STATE_COORDINATE_FUND_OFFSET: usize = 1104;
const STATE_COORDINATE_READINESS_OFFSET: usize = 1136;
const STATE_COORDINATE_CUSTODY_OFFSET: usize = 1168;
const STATE_COORDINATE_RENT_CREDIT_OFFSET: usize = 1200;
const STATE_MARKET_RENT_OFFSET: usize = 1232;
const STATE_MARKET_DONATION_OFFSET: usize = 1240;
const STATE_HOARD_RENT_OFFSET: usize = 1248;
const STATE_HOARD_DONATION_OFFSET: usize = 1256;
const STATE_FUND_RENT_OFFSET: usize = 1264;
const STATE_FUND_DONATION_OFFSET: usize = 1272;
const STATE_READINESS_RENT_OFFSET: usize = 1280;
const STATE_READINESS_DONATION_OFFSET: usize = 1288;
const STATE_CUSTODY_RENT_OFFSET: usize = 1296;
const STATE_CUSTODY_DONATION_OFFSET: usize = 1304;
const STATE_DEFERRED_CUSTODY_RENT_OFFSET: usize = 1312;
const STATE_RENT_CREDIT_OFFSET: usize = 1320;
const STATE_FUNDING_ALLOCATION_OFFSET: usize = 1328;
const STATE_INITIAL_WORK_CAPITAL_OFFSET: usize = 1360;
const STATE_TERMINAL_RECEIPT_OFFSET: usize = 1368;
const STATE_TERMINAL_FUNDING_REMAINING_OFFSET: usize = 1400;
const STATE_HOARD_PRINCIPAL_OFFSET: usize = 1408;
const REQUEST_MAGIC_OFFSET: usize = 0;
const REQUEST_VERSION_OFFSET: usize = 8;
const REQUEST_ACTION_OFFSET: usize = 10;
const REQUEST_HOLDER_OFFSET: usize = 11;
const REQUEST_REPRESENTATION_OFFSET: usize = 12;
const REQUEST_RESERVED_A_OFFSET: usize = 13;
const REQUEST_OUTCOME_OFFSET: usize = 16;
const REQUEST_RESERVED_B_OFFSET: usize = 20;
const REQUEST_QUANTITY_OFFSET: usize = 24;
const REQUEST_GENERATION_OFFSET: usize = 32;
const REQUEST_MARKET_OFFSET: usize = 40;
