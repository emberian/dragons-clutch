...
pub const STATE_BYTES: usize = 368;
pub const REQUEST_BYTES: usize = 72;
pub const ACTION_FOUND_TAG: u8 = 0;
pub const ACTION_VERIFY_READINESS_TAG: u8 = 1;
...
const STATE_REGISTRY_PROGRAM_OFFSET: usize = 240;
const STATE_GENERATION_OFFSET: usize = 272;
const STATE_OUTSTANDING_CAPABILITIES_OFFSET: usize = 280;
const STATE_PRINCIPAL_CAP_SETS_OFFSET: usize = 288;
const STATE_RENT_BENEFICIARY_OFFSET: usize = 296;
const STATE_TERMINAL_RECEIPT_OFFSET: usize = 328;
