...
pub use generated_physical::{
    ...
    CORE_EFFECT_ENVELOPE_BYTES_V1, CORE_EFFECT_MAGIC_V1, MARKET_CORE_STATE_PDA_DOMAIN_V1,
    PHYSICAL_ABI_VERSION_V1, SERIES_CORE_ACK_BYTES_V1, SERIES_CORE_ACK_MAGIC_V1,
