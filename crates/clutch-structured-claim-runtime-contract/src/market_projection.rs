...
use clutch_product_series::{
    ...
    ProductTemplateV4, SeriesAttachmentPlanId, SeriesAttachmentPlanV1, SeriesPlanV5,
    SeriesPlanV5Id,
};
...
pub const STRUCTURED_MARKET_PROJECTION_PREIMAGE_BYTES_V1: usize = 308;
...
mod tests {
    ...
    fn exhaustive_states_refuse_mixed_or_unreceipted_terminal_counts() {
        let base = StructuredMarketProjectionV1 {
            ...
            wrapper_recipe_set_id: ContentId::from_bytes([4; 32]),
    ...
    fn projection_preimage_commits_every_exact_identity_and_count() {
        let projection = StructuredMarketProjectionV1 {
            ...
            compiler_release_id: ContentId::from_bytes([6; 32]),
            capability_profile_id: ContentId::from_bytes([7; 32]),
            owner_release_id: ContentId::from_bytes([8; 32]),
            structured_root_id: ContentId::from_bytes([9; 32]),
