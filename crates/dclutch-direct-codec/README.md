...
The registered successor adds a Lean-specialized 232-byte state, 32-byte fill
request, 24-byte terminal request, 16-byte claim-owner requests, and 168-byte
lifecycle program. The Rust implementation is not a second semantic authority.
