...
outcome count rather than requiring a universal ClaimBasis account. Product
Terms remain content-addressed semantics rather than universal runtime state.
