...
pub const CANDIDATE_ORDER_AGGREGATE_ROW_BYTES_V1: usize =
    CANDIDATE_ORDER_DIRECTORY_ROW_BYTES_V1;
pub const CANDIDATE_ORDER_SLICE_EDGE_BYTES_V1: usize =
    CANDIDATE_ORDER_SLICE_REFERENCE_BYTES_V1;
