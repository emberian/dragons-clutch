...
| DealerQuoteAdmissionV1 | `DCQADMV1` | 6,948 | nine signed policy/facility/State/Epoch/SettlementRoot/Feed/candidate/fee identities `12..300`; issuance/selection-expiry/collect/deadline/width `300..340`; exact 64-row Dealer fill body `340..2908`; exact proof-independent quote/receipt/envelopes `2908..6948`. This is relayed signed input, never a persisted semantic owner. |
| CoveredDealerSelectionV1 | `DCCOVDV1` | 5,436 | 28 exact General/Dealer/fee/Lease/Pot identities `12..908`; generation/ordinal/slot/selection-expiry/collect/deliver `908..964`; derived receipt/trade `964..1236`; 64 uniquely derived allocations `1236..5332`; external-fee total/width/bump `5332..5356`; child rent `5356..5436`. Global envelope coordinate is `0xae/1`, for 5,444 account bytes. |
| DealerLeaseV2 | `DCLSEV02` | 1,132 | 31 exact State/SettlementRoot/CoveredDealerSelection/Position/Epoch/fee/liveness/Lease/Pot identities `12..1004`; generation/deadlines `1004..1044`; width/row-count/padding `1044..1052`; child rent `1052..1132` |
