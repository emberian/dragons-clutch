...
| DealerQuoteAdmissionV1 | `DCQADMV1` | 6,932 | nine signed policy/facility/State/Epoch/SettlementRoot/Feed/candidate/fee identities `12..300`; issuance/expiry/width `300..324`; exact 64-row Dealer fill body `324..2892`; exact proof-independent quote/receipt/envelopes `2892..6932`. This is relayed signed input, never a persisted semantic owner. |
| CoveredDealerSelectionV1 | `DCCOVDV1` | 5,420 | 28 exact General/Dealer/fee/Lease/Pot identities `12..908`; generation/ordinal/slot/expiry `908..948`; derived receipt/trade `948..1220`; 64 uniquely derived allocations `1220..5316`; external-fee total/width/bump `5316..5340`; child rent `5340..5420`. Global envelope coordinate is `0xae/1`, for 5,428 account bytes. |
