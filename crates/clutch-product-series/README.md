...
| `RegistryCapabilityProfileV2` | 808: header `0..16`, exact RegistryRelease ID `16..48`, selector mappings and hard limits including interval width/chunk bounds plus the Dealer/Fractional/Structured enablement bitmap `48..104`, fourteen semantic-owner IDs `104..552`, immutable Realm collateral `552..752`, exact SummaryProgram body `752..808`; the capability-profile ID is derived from the complete body and is not stored inside it | `dragons-clutch/registry-capability-profile/v2` |
