...
pub use artifacts::{
    ...
    MAX_RECOVERY_ATTEMPTS, MAX_SERIES_INSTANCES, MAX_SERIES_WINDOW_BUCKETS,
    NATIVE_CLAIM_BASIS_DOMAIN, PAYOUT_MAP_UNUSED, PRODUCT_TEMPLATE_BYTES, PRODUCT_TEMPLATE_DOMAIN,
    RECOVERY_POLICY_DOMAIN, SERIES_ATTACHMENT_PLAN_BYTES, SERIES_ATTACHMENT_PLAN_DOMAIN,
    SERIES_FUNDING_TERMS_BYTES, SERIES_FUNDING_TERMS_DOMAIN, SERIES_PLAN_BYTES, SERIES_PLAN_DOMAIN,
