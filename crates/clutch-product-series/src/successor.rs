...
use crate::{
    ...
    SeriesAttachmentPlanV2, SeriesAttachmentPlanV3, SeriesFundingQuoteId, SeriesFundingQuoteV1,
    SeriesFundingTermsV2Id, SeriesPlanV5Id, MAX_BASIS_DEGREE, MAX_OUTCOMES, MAX_PAYOUTS,
...
impl SeriesPlanV5 {
    ...
    /// Validate the same economic Series against the current V3 attachment.
    #[allow(clippy::too_many_arguments)]
